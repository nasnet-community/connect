...
const AUTH_REDIRECT_URL = isServer 
  ? (process.env.AUTH_REDIRECT_URL || import.meta.env.VITE_AUTH_REDIRECT_URL || '/')
  : (import.meta.env.VITE_AUTH_REDIRECT_URL || '/');

// eslint-disable-next-line @typescript-eslint/no-unused-vars
const AUTH_SESSION_TIMEOUT = isServer 
  ? parseInt(process.env.AUTH_SESSION_TIMEOUT || import.meta.env.VITE_AUTH_SESSION_TIMEOUT || "3600000", 10)
