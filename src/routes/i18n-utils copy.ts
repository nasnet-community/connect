...
// import SK from "../locales/message.sk.json";
...
// export type SupportedLocales = 'en' | 'it' | 'ru' | 'fa' | 'zh' | 'ar' | 'tr' | 'sk' | 'fr' | 'sp';

// export const SUPPORTED_LOCALES: SupportedLocales[] = ['en', 'it', 'ru', 'fa', 'zh', 'ar', 'tr', 'sk', 'fr', 'sp'];
...
//   [SK, EN, FR, SP, IT, RU, FA, ZH, AR, TR].forEach(({ translations, locale }) => {
