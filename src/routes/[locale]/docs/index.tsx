  ...
  const categories = [
    {
      ...
      description:
        "Components for visualizing data, connections, and relationships",
      components: [
        {
          id: "graph",
          name: "Graph",
    ...
    <div>
      <div class="mb-8">
        ...
        <p class="text-slate-600 dark:text-slate-300">
          Explore our library of reusable components with examples and usage
          guidelines
        </p>
      </div>
              ...
              {category.components.length > 0 ? (
                category.components.map((component) => (
                  <Link
                    key={component.id}
                    href={component.path}
                    class="flex items-center justify-between rounded-md p-3 transition-colors hover:bg-slate-50 dark:hover:bg-slate-700"
                  >
                    <div>
                ...
                <div class="py-6 text-center text-sm italic text-slate-400 dark:text-slate-500">
