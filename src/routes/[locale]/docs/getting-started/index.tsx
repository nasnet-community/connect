    ...
    <DocsLayout>
      <div class="mx-auto max-w-3xl">
        ...
        <p class="mb-6 text-lg text-gray-700 dark:text-gray-300">
          This guide will help you get started with the Connect Design System in
          your Qwik application.
        </p>
        ...
        <section class="mb-10">
          ...
          <p class="mb-4 text-gray-700 dark:text-gray-300">
            The Connect Design System is available as part of your Qwik project.
            If you're starting from scratch, you'll need to set up a Qwik
            project first:
          </p>
          ...
          <p class="mb-4 mt-4 text-gray-700 dark:text-gray-300">
            Once your Qwik project is set up, you can install the Connect Design
            System:
          </p>
        ...
        <section class="mb-10">
          ...
          <p class="mb-4 text-gray-700 dark:text-gray-300">
            The first step is to set up the Connect theme provider in your
    ...
    <QwikCityProvider>
      <ThemeProvider defaultTheme="light">
        <RouterOutlet />
          ...
          <p class="mb-4 mt-4 text-gray-700 dark:text-gray-300">
            Make sure to include the Connect styles by updating your global CSS
            file:
          </p>
  ...
  return (
    <Container maxWidth="md" class="py-8">
      ...
      <Button variant="primary">Get Started</Button>
          ...
          <p class="mb-4 mt-4 text-gray-700 dark:text-gray-300">
            Remember that with Qwik, all event handlers need to use the $
            suffix:
          </p>
    ...
    <form preventdefault:submit onSubmit$={handleSubmit$} class="space-y-4">
      ...
      <Button type="submit" variant="primary">
        ...
        <section class="mb-10">
          ...
          <p class="mb-4 text-gray-700 dark:text-gray-300">
            Connect provides layout components for building responsive
            interfaces:
          </p>
    ...
    <Container maxWidth="lg" class="py-8">
      ...
      >
        ...
        <section class="mb-10">
          ...
          <p class="mb-4 text-gray-700 dark:text-gray-300">
            You can customize the theme by using the ThemeProvider and accessing
            theme values:
          </p>
    ...
    <ThemeProvider defaultTheme="light">
      ...
      <main class="p-6">
          ...
          <div class="space-y-4">
            <div class="rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800">
              <h3 class="mb-2 font-medium text-gray-900 dark:text-white">
                Follow Qwik Patterns
              </h3>
              <p class="text-gray-700 dark:text-gray-300">
                Remember to use the $ suffix for event handlers and create
                lazy-loaded functions with $(). This is crucial for Qwik's
                resumability model.
              </p>
            </div>
            ...
            <div class="rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800">
              ...
              <p class="text-gray-700 dark:text-gray-300">
                Use the composite components like Card with CardHeader,
                CardBody, etc. instead of configuring a single component with
                many props.
              </p>
            </div>
            ...
            <div class="rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800">
              ...
              <p class="text-gray-700 dark:text-gray-300">
                Use the responsive object syntax for props that support it, like
                cols in Grid.
              </p>
            </div>
            ...
            <div class="rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800">
              ...
              <p class="text-gray-700 dark:text-gray-300">
                Always provide proper labels, aria attributes, and ensure
                keyboard navigation works. Connect components have built-in
                accessibility, but you need to use them correctly.
              </p>
            </div>
            ...
            <div class="rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800">
              ...
              <p class="text-gray-700 dark:text-gray-300">
                Test your application in both light and dark modes to ensure
        ...
        <section class="mb-10">
          ...
          <p class="mb-4 text-gray-700 dark:text-gray-300">
            Now that you're familiar with the basics, explore these resources to
            learn more:
          </p>
          ...
          <ul class="list-disc space-y-2 pl-6 text-gray-700 dark:text-gray-300">
            <li>
              ...
              - Learn about the design tokens that power the Connect system
            </li>
            <li>
              <a
            ...
            <li>
              ...
              - Detailed API documentation for all Connect components
            </li>
            <li>
              <a
              ...
              - Learn about the patterns and structure of Connect components
            </li>
          </ul>
        </section>
      </div>
