...
export const head: DocumentHead = {
  ...
  meta: [
    {
      name: 'description',
      content: 'The FormHelperText component provides contextual assistance and guidance for form fields with support for different visual states and accessibility features.'
    }
  ]
}; 