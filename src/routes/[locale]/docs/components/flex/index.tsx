  ...
  meta: [
    {
      name: "description",
      content:
        "A layout component for one-dimensional layouts using the CSS Flexbox module in the Connect design system.",
    },
    {
      name: "keywords",
      content:
        "flex, flexbox, layout, responsive, direction, align, justify, gap, Qwik UI, Connect, design system",
    },
  ],
};
