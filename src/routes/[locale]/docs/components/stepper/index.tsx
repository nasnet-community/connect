    ...
    <div>
      <div class="mb-8">
        ...
        <p class="mt-2 max-w-3xl text-lg text-gray-600 dark:text-gray-300">
          Guide users through multi-step processes with configurable, accessible
          stepper components
        </p>
      </div>
      ...
      <section class="mb-12">
        <Card variant="elevated">
          <div class="prose max-w-none dark:prose-invert">
            ...
            <p>
              The Stepper component helps guide users through multi-step
              processes such as onboarding flows, checkout processes, or any
              workflow that requires structured progression through multiple
              stages. Each step can contain custom content while the stepper
            ...
            <ul>
              <li>
                Three layout variations: Content-focused (CStepper), Horizontal
                (HStepper), and Vertical (VStepper)
              </li>
      ...
      <section class="mb-12">
        <h2 class="mb-6 flex items-center text-2xl font-bold text-gray-900 dark:text-white">
          <HiPlayOutline class="mr-2 h-6 w-6 text-primary-500" />
          Stepper Variants
        </h2>
        ...
        <div class="space-y-8">
          ...
          <Card variant="elevated">
            <div q:slot="header" class="flex items-center justify-between">
              <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                Content Stepper (CStepper)
              </h3>
              <span class="inline-flex items-center rounded-full bg-blue-100 px-2.5 py-1 text-xs font-medium text-blue-800 dark:bg-blue-900/40 dark:text-blue-300">
                Recommended
              </span>
            </div>
            <div>
              <p class="mb-4 text-sm text-gray-600 dark:text-gray-300">
                Content-focused stepper with top navigation, ideal for
                form-based wizards and guided experiences where the content is
                the main focus.
              </p>
          ...
          <Card variant="elevated">
            <div q:slot="header" class="flex items-center justify-between">
              <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                Horizontal Stepper (HStepper)
              </h3>
              <span class="inline-flex items-center rounded-full bg-purple-100 px-2.5 py-1 text-xs font-medium text-purple-800 dark:bg-purple-900/40 dark:text-purple-300">
                Fullscreen
              </span>
            </div>
            <div>
              <p class="mb-4 text-sm text-gray-600 dark:text-gray-300">
                Full-screen stepper with horizontal navigation, perfect for
                onboarding experiences and guided tours where each step takes
                the full viewport.
              </p>
              <div class="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800">
                <div class="py-6 text-center text-gray-500 dark:text-gray-400">
          ...
          <Card variant="elevated">
            ...
            <div>
              <p class="mb-4 text-sm text-gray-600 dark:text-gray-300">
                Vertical layout with steps stacked in a single scrollable view,
                best for mobile interfaces or when you want to show all steps in
                a single view for easy comparison.
              </p>
              <div class="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800">
                <div class="py-6 text-center text-gray-500 dark:text-gray-400">
              ...
              <tbody class="divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-transparent">
                <tr>
                  ...
                  <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">
                    Array of step metadata including titles, descriptions, and
                    components
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">
                    Additional steps that can be added dynamically
                  </td>
                </tr>
                <tr>
                  <td class="whitespace-nowrap px-6 py-4 text-sm font-medium text-gray-900 dark:text-white">
                  ...
                  <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">
                    Index of the initially active step
                  </td>
                </tr>
                <tr>
                  <td class="whitespace-nowrap px-6 py-4 text-sm font-medium text-gray-900 dark:text-white">
                ...
                <tr>
                  ...
                  <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">
                    Custom context ID for stepper state
                  </td>
                </tr>
                <tr>
                  <td class="whitespace-nowrap px-6 py-4 text-sm font-medium text-gray-900 dark:text-white">
                  ...
                  <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">
                    Custom data to be shared across steps
                  </td>
                </tr>
              </tbody>
            </table>
              ...
              <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tbody class="divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-transparent">
                  ...
                  <tr>
                    ...
                    <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">
                      Title displayed in the stepper
                    </td>
                  </tr>
                  <tr>
                    <td class="whitespace-nowrap px-6 py-4 text-sm font-medium text-gray-900 dark:text-white">
                  ...
                  <tr>
                    ...
                    <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">
                      Whether the step is hidden from view
                    </td>
                  </tr>
                  <tr>
                    <td class="whitespace-nowrap px-6 py-4 text-sm font-medium text-gray-900 dark:text-white">
      ...
      <section class="mb-12">
        ...
        <Card variant="elevated" noPadding>
          <div class="rounded-lg bg-gray-900">
            ...
            <pre class="overflow-x-auto p-4 text-gray-300">
        ...
        <div class="mt-8 grid grid-cols-1 gap-6 md:grid-cols-2">
          <Card variant="elevated">
            ...
            <p class="text-gray-600 dark:text-gray-300">
              The CStepper provides a context API for sharing state between
              steps. Use
              <code class="mx-1 rounded bg-gray-100 px-1 py-0.5 text-sm dark:bg-gray-800">
              ...
              to access and manipulate stepper state from within step
              components.
            </p>
          </Card>
          ...
          <Card variant="elevated">
            ...
            <p class="text-gray-600 dark:text-gray-300">
              The Stepper components are built with accessibility in mind,
              featuring proper ARIA attributes, keyboard navigation, and focus
              management. Step progression announcements are provided for screen
              readers through an invisible live region.
            </p>
          </Card>
        </div>
      </section>
