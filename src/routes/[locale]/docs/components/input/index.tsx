      ...
      components: [
        {
          name: "Button",
          description:
            "Interactive element for triggering actions with multiple variants and states",
        ...
        },
        {
          name: "Select",
          description:
            "Dropdown selection component with search and option grouping capabilities",
        ...
        },
        {
          name: "Switch",
          description:
            "Toggle control for binary options with customizable styling",
