  ...
  const componentGroups: ComponentGroup[] = [
    {
      ...
      components: [
        ...
        {
          name: "Drawer",
          description: "Side and edge panels that slide in from screen edges for supplementary content.",
          path: `/${locale}/docs/components/feedback/drawer`,
          status: "stable"
        },
        {
          name: "Error Message",
          description: "Components for displaying error messages in forms or other contexts.",
          path: `/${locale}/docs/components/feedback/errormessage`,
          status: "stable"
        },
        {
          name: "Popover",
          description: "Floating content that appears when interacting with a trigger element.",
          path: `/${locale}/docs/components/feedback/popover`,
          status: "stable"
        },
        {
          name: "Promo Banner",
          description: "Promotional messaging displays for announcements and marketing content.",
          path: `/${locale}/docs/components/feedback/promobanner`,
          status: "stable"
        },
        {
          name: "Toast",
          description: "Temporary notifications with positioning options and auto-dismiss functionality.",
