    ...
    >
      ...
      <section class="mb-12">
        ...
        <p class="mb-4 text-gray-700 dark:text-gray-300">
          ...
          prop to define the number of columns in your grid.
        </p>
    ...
    <Box padding="md" backgroundColor="info" borderRadius="md">Spans 2 columns</Box>
      ...
      <section class="mb-12">
        ...
        <p class="mb-4 text-gray-700 dark:text-gray-300">
          ...
          prop to control the spacing between grid items. You can also use{" "}
          <code class="rounded bg-gray-100 px-1 py-0.5 text-sm dark:bg-gray-800">
            columnGap
          </code>{" "}
          and{" "}
...
<Grid columns="3" columnGap="xs" rowGap="xl">
  ...
  <Box padding="md" backgroundColor="warning" borderRadius="md">Item</Box>
      ...
      <section class="mb-12">
        ...
        <p class="mb-4 text-gray-700 dark:text-gray-300">
          Create responsive layouts by passing an object to the{" "}
          <code class="rounded bg-gray-100 px-1 py-0.5 text-sm dark:bg-gray-800">
            columns
          </code>{" "}
          prop with different values for each breakpoint.
        </p>
        <div class="mb-4 rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
          <div class="space-y-2">
            <p class="mb-2 text-gray-700 dark:text-gray-300">This grid has:</p>
...
>
  ...
  <Box padding="md" backgroundColor="success" borderRadius="md">Item 8</Box>
      ...
      <section class="mb-12">
        ...
        <p class="mb-4 text-gray-700 dark:text-gray-300">
          Create responsive grids that automatically adjust the number of
          columns based on available space using{" "}
          <code class="rounded bg-gray-100 px-1 py-0.5 text-sm dark:bg-gray-800">
            auto-fit
          </code>{" "}
          or{" "}
          ...
          prop controls the minimum width of each column.
        </p>
        <div class="mb-4 rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
          <div class="space-y-8">
            <div>
            ...
            <div>
              ...
              <p class="mb-2 text-sm text-gray-700 dark:text-gray-300">
                Auto-fill will add as many columns as possible, potentially
...
<Grid columns="auto-fill" minColumnWidth="150px" gap="md">
  ...
  <Box padding="md" backgroundColor="secondary" borderRadius="md">Item 4</Box>
      ...
      <section class="mb-12">
        ...
        <table class="mb-8 min-w-full divide-y divide-gray-200 dark:divide-gray-700">
          ...
          <tbody class="divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-800">
            <tr>
              ...
              <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-500 dark:text-gray-300">
                string | number | ResponsiveObject
              </td>
              <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-500 dark:text-gray-300">
                '1'
              </td>
              <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-300">
                Number of columns or responsive object with breakpoints
              </td>
            </tr>
            <tr>
              <td class="whitespace-nowrap px-6 py-4 text-sm font-medium text-gray-900 dark:text-white">
            ...
            <tr>
              ...
              <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-300">
                Custom CSS grid-template-columns value
              </td>
            </tr>
            <tr>
              <td class="whitespace-nowrap px-6 py-4 text-sm font-medium text-gray-900 dark:text-white">
              ...
              <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-300">
                Custom CSS grid-template-rows value
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
          ...
          <tbody class="divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-800">
            ...
            <tr>
              ...
              <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-300">
                Horizontal alignment for this specific item
              </td>
            </tr>
            <tr>
              <td class="whitespace-nowrap px-6 py-4 text-sm font-medium text-gray-900 dark:text-white">
              ...
              <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-300">
                Vertical alignment for this specific item
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <div class="mt-4">
          <h3 class="mb-2 text-lg font-medium">Type Definitions</h3>
          <CodeExample
  ...
  '2xl'?: string;
      ...
      <section class="mb-12">
        ...
        <div class="space-y-4 text-gray-700 dark:text-gray-300">
          ...
          <ul class="list-inside list-disc space-y-2 pl-4">
            <li>
              Uses semantic HTML structure with appropriate ARIA attributes when
              necessary
            </li>
            <li>
              Maintains a logical DOM order to ensure keyboard navigation
              follows a predictable path
            </li>
            <li>
              Supports ARIA roles and labels for landmark regions when needed
            </li>
            <li>Preserves content readability at various viewport sizes</li>
            <li>
              Avoids accessibility issues common with visual grid layouts by
              using CSS Grid instead of older techniques
            </li>
          </ul>

          <div class="mt-4 rounded-md border border-amber-200 bg-amber-50 p-4 dark:border-amber-800 dark:bg-amber-900/20">
            <h3 class="mb-2 font-medium text-amber-800 dark:text-amber-400">
              Important Considerations
            </h3>
            <p class="text-amber-700 dark:text-amber-300">
              When using Grid for complex layouts, be mindful that the visual
              order might not match the DOM order. This can affect keyboard
              navigation, so ensure the source order remains logical for screen
              reader users.
            </p>
          </div>
        </div>
      ...
      <section class="mb-12">
        ...
        <div class="space-y-4 text-gray-700 dark:text-gray-300">
          <ul class="list-inside list-disc space-y-2 pl-4">
            <li>
              <strong>Choose the right layout component</strong>: Use Grid for
              two-dimensional layouts. For simpler one-dimensional layouts,
              consider using Stack instead.
            </li>
            <li>
              <strong>Responsive design</strong>: Leverage the responsive column
              properties to create layouts that adapt to different screen sizes.
            </li>
            <li>
              <strong>Auto-fit vs. auto-fill</strong>: Use auto-fit when you
              want items to stretch and fill the container, and auto-fill when
              you want to maintain item sizes and possibly have empty tracks.
            </li>
            <li>
              <strong>Logical source order</strong>: Keep the DOM order logical
              for accessibility, even if the visual presentation is different.
            </li>
            <li>
              <strong>Consistent gaps</strong>: Use consistent gap sizes
              throughout your application for visual harmony.
            </li>
            <li>
              <strong>Complex layouts</strong>: For more complex layouts,
              combine Grid with GridItem components to precisely control item
              placement.
            </li>
            <li>
              <strong>Minimize media queries</strong>: Let the Grid component's
              responsive features handle layout changes instead of writing
              custom media queries.
            </li>
            <li>
              <strong>Performance</strong>: Be mindful of nesting too many
              grids, as it can affect performance; flatten your structure when
              possible.
            </li>
          </ul>
        </div>
      ...
      <section class="mb-12">
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
          <Card variant="elevated" class="p-4">
            <h3 class="mb-2 text-lg font-medium">Box</h3>
            <p class="text-sm text-gray-700 dark:text-gray-300">
              A foundational layout component for creating containers with
              consistent styling.
            </p>
          </Card>
          <Card variant="elevated" class="p-4">
            <h3 class="mb-2 text-lg font-medium">Stack</h3>
            <p class="text-sm text-gray-700 dark:text-gray-300">
              A layout component for arranging elements in a one-dimensional
              stack with consistent spacing.
            </p>
          </Card>
          <Card variant="elevated" class="p-4">
            <h3 class="mb-2 text-lg font-medium">Container</h3>
            <p class="text-sm text-gray-700 dark:text-gray-300">
              A layout component for constraining content width and providing
              consistent padding.
            </p>
          </Card>
        </div>
