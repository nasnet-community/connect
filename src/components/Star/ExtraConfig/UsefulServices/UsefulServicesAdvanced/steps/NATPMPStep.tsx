...
import { Card, CardHeader, Toggle, Alert } from "~/components/Core";
  ...
  const validateAndUpdate$ = $(() => {
    ...
    const natpmpConfig: NATPMPConfig = {
      linkType: natpmpEnabled.value
        ? selectedInterface.value?.type === "domestic"
          ? "domestic"
          : selectedInterface.value?.type === "foreign"
            ? "foreign"
            : selectedInterface.value?.type === "vpn"
              ? "vpn"
              : ""
        : "",
      ...
      {natpmpEnabled.value && (
        <div class="animate-fade-in-up space-y-6">
          ...
          {getAllInterfaces().then((interfaces) => {
            ...
            const domesticInterfaces = interfaces.filter(
              (i) => i.type === "domestic",
            );
            const foreignInterfaces = interfaces.filter(
              (i) => i.type === "foreign",
            );
                  ...
                  <div class="space-y-4">
                    <div class="flex items-center gap-3">
                      ...
                      <span class="inline-flex items-center rounded-full bg-blue-100 px-2.5 py-0.5 text-xs font-medium text-blue-800 dark:bg-blue-900/50 dark:text-blue-300">
                        ...
                        {domesticInterfaces.length === 1 ? "link" : "links"}
                      </span>
                    </div>
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                      {domesticInterfaces.map((iface) => {
                        const isSelected =
                          selectedInterface.value?.value === iface.value;
                        return (
                          <div
                            key={iface.value}
                  ...
                  <div class="space-y-4">
                    <div class="flex items-center gap-3">
                      ...
                      <span class="inline-flex items-center rounded-full bg-green-100 px-2.5 py-0.5 text-xs font-medium text-green-800 dark:bg-green-900/50 dark:text-green-300">
                        ...
                        {foreignInterfaces.length === 1 ? "link" : "links"}
                      </span>
                    </div>
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                  ...
                  <div class="space-y-4">
                    <div class="flex items-center gap-3">
                      ...
                      <span class="inline-flex items-center rounded-full bg-purple-100 px-2.5 py-0.5 text-xs font-medium text-purple-800 dark:bg-purple-900/50 dark:text-purple-300">
                        ...
                        {vpnInterfaces.length === 1 ? "client" : "clients"}
                      </span>
                    </div>
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                          ...
                          >
                            <div class="flex items-start gap-3">
                              ...
                              <div class="min-w-0 flex-1">
                                ...
                                <div class="mt-2 flex items-center gap-1">
                                  <span
                                    class={`inline-flex items-center gap-1 rounded border px-2 py-0.5 text-xs font-medium ${getTypeColorClasses("vpn")}`}
                                  >
