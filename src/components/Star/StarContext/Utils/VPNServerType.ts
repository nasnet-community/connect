...
export type IpsecPolicyAction = "discard" | "encrypt" | "none";
export type IpsecPolicyLevel = "require" | "unique" | "use";
export type IpsecPolicyProtocol = "all" | "icmp" | "tcp" | "udp" | string;
...
export type IpsecIdentityEapMethod =
  ...
  | "eap-tls"
  | "eap-ttls";
export type IpsecIdentityMatchBy = "remote-id" | "certificate";
