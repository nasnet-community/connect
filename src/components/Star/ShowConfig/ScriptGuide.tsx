              ...
              >
                <div class="relative h-[95vh] w-[95vw]">
                  <button
                    ...
                    class="absolute -right-2 -top-2 z-10 rounded-full bg-surface p-2 
                          shadow-lg transition-colors hover:bg-surface-hover 
                          dark:bg-surface-dark dark:hover:bg-surface-dark-hover"
