...
export const vpnProtocols = [
  {
    ...
    features: [
      $localize`Fastest`,
      $localize`Modern crypto`,
      $localize`Low latency`,
    ],
  ...
  },
  {
    ...
    features: [
      $localize`Enterprise`,
      $localize`IPSec encryption`,
      $localize`NAT support`,
    ],
  ...
  },
  {
    ...
    features: [
      $localize`Mobile optimized`,
      $localize`Auto-reconnect`,
      $localize`Fast handoff`,
    ],
  ...
  },
  {
    ...
    features: [
      $localize`Firewall friendly`,
      $localize`SSL encryption`,
      $localize`Windows native`,
    ],
  ...
  },
  {
    ...
    features: [
      $localize`Legacy support`,
      $localize`Simple setup`,
      $localize`Wide compatibility`,
    ],
