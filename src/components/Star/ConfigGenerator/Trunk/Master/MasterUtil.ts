...
export const generateBaseNetworkVLANs = (
    subnets: Subnets,
...
export const generateAdditionalNetworkVLANs = (
    subnets: Subnets,
    trunkInterface: string,
): RouterConfig => {
    const configs: RouterConfig[] = [];
...
export const generateVPNClientNetworkVLANs = (
    subnets: Subnets,
    trunkInterface: string,
): RouterConfig => {
    const configs: RouterConfig[] = [];
...
export const addTrunkInterfaceToBridge = (
    choose: ChooseState,
    trunkInterface: string,
): RouterConfig => {
    const config: RouterConfig = {
...
export const generateWirelessTrunkInterface = (
