...
import { ScriptAndScheduler, OneTimeScript } from "~/components/Star/ConfigGenerator";
...
export const generateDomesticIPScript = ( time: string, interval: FrequencyValue = "Daily" ): RouterConfig => {
    ...
    const scriptCommands: string[] = [
        ...
        ':local sourceAddress "192.168.30.1"',
        "# ==================================================",
        "",
        ...
        "                :if ($attempt = 3) do={ :set delayTime 20 }",
        "                :if ($attempt = 4) do={ :set delayTime 30 }",
        "                :if ($attempt = 5) do={ :set delayTime 60 }",
