...
// import { WirelessConfig, SingleSSID, MultiSSID } from "./Wireless";
// import {
//   GetNetworks,
//   SSIDListGenerator,
//   Passphrase,
...
//       expect(commands.some((cmd) => cmd.includes("HomeNetwork 2.4"))).toBe(
//         true,
//       );
...
//       expect(
//         commands.some((cmd) => cmd.includes("configuration.hide-ssid=yes")),
//       ).toBe(true);
//     });
...
//       const commands = result["/interface wifi"];
//       expect(commands.some((cmd) => cmd.includes("master-interface"))).toBe(
//         true,
//       );
//     });
...
//       const commands = result["/interface wifi"];
//       expect(
//         commands.filter((cmd) => cmd.includes("master-interface")).length,
//       ).toBe(2);
//     });
//   });
...
//       expect(
//         fiveGHzCommands.some((cmd) => cmd.includes("master-interface")),
//       ).toBe(true);
//     });
...
//         interfaceList.some(
//           (cmd: string) =>
//             cmd.includes("wifi2.4-SplitLAN") && cmd.includes("Split-LAN"),
//         ),
//       ).toBe(true);
//       expect(
//         interfaceList.some(
//           (cmd: string) =>
//             cmd.includes("wifi5-SplitLAN") && cmd.includes("Split-LAN"),
//         ),
//       ).toBe(true);
//       expect(
//         interfaceList.some(
//           (cmd: string) =>
//             cmd.includes("wifi2.4-SplitLAN") && cmd.includes("LAN"),
//         ),
//       ).toBe(true);
//       expect(
//         interfaceList.some(
//           (cmd: string) =>
//             cmd.includes("wifi5-SplitLAN") && cmd.includes("LAN"),
//         ),
//       ).toBe(true);
//     });
...
//         interfaceList.some(
//           (cmd: string) =>
//             cmd.includes("wifi2.4-VPNLAN") && cmd.includes("VPN-LAN"),
//         ),
//       ).toBe(true);
//       expect(
//         interfaceList.some(
//           (cmd: string) =>
//             cmd.includes("wifi5-VPNLAN") && cmd.includes("VPN-LAN"),
//         ),
//       ).toBe(true);
//       expect(
//         interfaceList.some(
//           (cmd: string) =>
//             cmd.includes("wifi2.4-VPNLAN") && cmd.includes("LAN"),
//         ),
//       ).toBe(true);
//       expect(
//         interfaceList.some(
//           (cmd: string) => cmd.includes("wifi5-VPNLAN") && cmd.includes("LAN"),
//         ),
//       ).toBe(true);
//     });
...
//       const fiveGHzCommands = commands.filter((cmd) =>
//         cmd.includes("wifi5-VPNLAN"),
//       );
//       expect(
//         fiveGHzCommands.some((cmd) =>
//           cmd.includes("master-interface=[ find default-name=wifi1 ]"),
//         ),
//       ).toBe(true);

//       // wifi2.4 should be master (not used as WAN)
//       const twoFourGHzCommands = commands.filter((cmd) =>
//         cmd.includes("wifi2.4-VPNLAN"),
//       );
//       expect(
//         twoFourGHzCommands.some((cmd) =>
//           cmd.includes("set [ find default-name=wifi2 ]"),
//         ),
//       ).toBe(true);
//     });
//   });
...
//         interfaceList.some(
//           (cmd: string) =>
//             cmd.includes("wifi2.4-FRNLAN") && cmd.includes("FRN-LAN"),
//         ),
//       ).toBe(true);
//       expect(
//         interfaceList.some(
//           (cmd: string) =>
//             cmd.includes("wifi5-FRNLAN") && cmd.includes("FRN-LAN"),
//         ),
//       ).toBe(true);
//       expect(
//         interfaceList.some(
//           (cmd: string) =>
//             cmd.includes("wifi2.4-FRNLAN") && cmd.includes("LAN"),
//         ),
//       ).toBe(true);
//       expect(
//         interfaceList.some(
//           (cmd: string) => cmd.includes("wifi5-FRNLAN") && cmd.includes("LAN"),
//         ),
//       ).toBe(true);
...
//       const bridgePorts = result["/interface bridge port"];
//       expect(bridgePorts.some((cmd: string) => cmd.includes("FRNLAN"))).toBe(
//         true,
//       );
//       expect(bridgePorts.some((cmd: string) => cmd.includes("DOMLAN"))).toBe(
//         true,
//       );
//       expect(bridgePorts.some((cmd: string) => cmd.includes("VPNLAN"))).toBe(
//         true,
//       );
//     });
...
//       const slaveCommands = commands.filter((cmd) =>
//         cmd.includes("master-interface"),
//       );
...
//       const wifi24Slaves = slaveCommands.filter((cmd) =>
//         cmd.includes("wifi2.4-"),
//       );
...
//       expect(bridgePorts.every((cmd: string) => cmd.includes("SplitLAN"))).toBe(
//         true,
//       );
//     });
//   });
...
//       expect(result["/interface bridge port"]).not.toEqual([]);
//       expect(
//         result["/interface bridge port"].some((cmd) =>
//           cmd.includes("LANBridgeSplit"),
//         ),
//       ).toBe(true);
//     });
...
//       expect(result["/interface bridge port"]).not.toEqual([]);
//       expect(
//         result["/interface bridge port"].some((cmd) => cmd.includes("FRNLAN")),
//       ).toBe(true);
//       expect(
//         result["/interface bridge port"].some((cmd) => cmd.includes("VPNLAN")),
//       ).toBe(true);
//     });
...
//         expect(result).toBe(
//           'add configuration.mode=ap security.authentication-types=wpa2-psk,wpa3-psk .passphrase="MyPassword123" disabled=no',
//         );
//       });
...
//           "[ find default-name=wifi1 ] comment=DomesticWAN",
//         );
//         expect(commands[0]).toContain("configuration.mode=station");
