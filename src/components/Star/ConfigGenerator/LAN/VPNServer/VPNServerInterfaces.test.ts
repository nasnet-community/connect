...
//                 result["/interface ovpn-server server"] || [];
//             expect(
...
//             const serverCommands =
//                 result["/interface pptp-server server"] || [];
//             expect(
//                 serverCommands.some((cmd: string) =>
//                     cmd.includes("enabled=yes"),
//                 ),
//             ).toBe(true);
//             expect(
//                 serverCommands.some((cmd: string) =>
...
//             const serverCommands =
//                 result["/interface l2tp-server server"] || [];
//             expect(
//                 serverCommands.some((cmd: string) =>
//                     cmd.includes("enabled=yes"),
//                 ),
...
//             const serverCommands =
//                 result["/interface sstp-server server"] || [];
//             expect(
//                 serverCommands.some((cmd: string) =>
//                     cmd.includes("enabled=yes"),
//                 ),
...
//             expect(
//                 firewallCommands.some((cmd: string) =>
...
//             expect(
//                 firewallCommands.some((cmd: string) =>
//                     cmd.includes("dst-port=500"),
//                 ),
//             ).toBe(true);
//             expect(
//                 firewallCommands.some((cmd: string) =>
//                     cmd.includes("dst-port=4500"),
//                 ),
//             ).toBe(true);
//         });
...
//             expect(
//                 comments.some((c: string) =>
//                     c.includes("WireGuard: 1 server(s)"),
//                 ),
//             ).toBe(true);
//             expect(
//                 comments.some((c: string) => c.includes("OpenVPN: Enabled")),
//             ).toBe(true);
//             expect(
//                 comments.some((c: string) => c.includes("PPTP: Enabled")),
//             ).toBe(true);
//             expect(
//                 comments.some((c: string) => c.includes("L2TP: Enabled")),
//             ).toBe(true);
//             expect(
//                 comments.some((c: string) => c.includes("SSTP: Enabled")),
//             ).toBe(true);
//             expect(
//                 comments.some((c: string) => c.includes("IKEv2: Enabled")),
//             ).toBe(true);
//         });
...
//             expect(
//                 comments.some((c: string) =>
//                     c.includes("OpenVPN: Not configured"),
//                 ),
//             ).toBe(true);
//         });
...
//             expect(
//                 serverCommands.some((cmd: string) =>
//                     cmd.includes("name=ovpn-minimal"),
//                 ),
//             ).toBe(true);
//         });
