...
//                     const listMemberCommands =
//                         result["/interface list member"] || [];
//                     const comments = result[""] || [];
...
//                             pptpCommands.some((cmd) =>
//                                 cmd.includes('user="multiuser"'),
//                             ),
//                             l2tpCommands.some((cmd) =>
//                                 cmd.includes('user="multiuser"'),
//                             ),
//                             sstpCommands.some((cmd) =>
//                                 cmd.includes('user="multiuser"'),
//                             ),
//                             ovpnCommands.some((cmd) =>
//                                 cmd.includes('user="multiuser"'),
//                             ),
//                         ],
//                     };
...
//             expect(
//                 l2tpCommands.some((cmd) => cmd.includes('user="user2"')),
//             ).toBe(true);
//             expect(
//                 l2tpCommands.some((cmd) => cmd.includes('user="multiuser"')),
//             ).toBe(true);
//             expect(
//                 pptpCommands.some((cmd) => cmd.includes('user="user2"')),
//             ).toBe(true);
//             expect(
//                 pptpCommands.some((cmd) => cmd.includes('user="multiuser"')),
//             ).toBe(true);
//             expect(
//                 sstpCommands.some((cmd) => cmd.includes('user="user3"')),
//             ).toBe(true);
//             expect(
//                 sstpCommands.some((cmd) => cmd.includes('user="multiuser"')),
//             ).toBe(true);
//             expect(
//                 ovpnCommands.some((cmd) => cmd.includes('user="user1"')),
//             ).toBe(true);
//             expect(
...
//             const comments = result[""] || [];
//             expect(
//                 comments.some((c) => c.includes("No credentials provided")),
//             ).toBe(true);
...
//                 comments.some((c) =>
//                     c.includes(
//                         "No users configured for supported VPN binding types",
//                     ),
//                 ),
//             ).toBe(true);
//         });
...
//                         hasExpectedNaming: [
//                             l2tpCommands.some((cmd) =>
//                                 cmd.includes('name="l2tp-testL2TP"'),
//                             ),
//                             pptpCommands.some((cmd) =>
//                                 cmd.includes('name="pptp-testPPTP"'),
//                             ),
//                             sstpCommands.some((cmd) =>
//                                 cmd.includes('name="sstp-testSSTP"'),
//                             ),
//                             ovpnCommands.some((cmd) =>
//                                 cmd.includes('name="ovpn-testOVPN"'),
//                             ),
//                         ],
//                     };
//                 },
...
//             expect(
//                 comments.some((c) => c.includes("Supported VPN types:")),
//             ).toBe(true);
//             expect(
//                 comments.some((c) =>
//                     c.includes("Static Interface Binding Benefits:"),
...
//                     cmd.includes('name="user1"'),
//                 ),
//             ).toBe(true);
//             expect(
//                 peerCommands.some((cmd: string) =>
//                     cmd.includes('name="multiuser"'),
//                 ),
//             ).toBe(true);
//         });
...
//                 secretCommands.some(
//                     (cmd: string) =>
//                         cmd.includes('name="user2"') &&
//                         cmd.includes("service=pptp"),
//                 ),
//             ).toBe(true);
//             expect(
//                 secretCommands.some(
...
//                 secretCommands.some(
//                     (cmd: string) =>
//                         cmd.includes('name="user3"') &&
//                         cmd.includes("service=sstp"),
//                 ),
//             ).toBe(true);
//             expect(
//                 secretCommands.some(
...
//                 comments.some((c: string) =>
//                     c.includes(
//                         "IKEv2 users are managed through IPsec identities",
//                     ),
//                 ),
//             ).toBe(true);
//             expect(
...
//             ).toBe(true);
//             expect(
//                 comments.some((c: string) => c.includes("Total users: 4")),
//             ).toBe(true);
//         });
...
//             expect(
//                 pptpCommands.filter((cmd: string) => cmd.includes("add"))
//                     .length,
//             ).toBe(2);
//             expect(
//                 pptpCommands.some((cmd: string) =>
//                     cmd.includes('name="pptp-only"'),
//                 ),
//             ).toBe(true);
//             expect(
//                 pptpCommands.some((cmd: string) =>
//                     cmd.includes('name="multi-vpn"'),
//                 ),
//             ).toBe(true);
//         });
...
//             );
//             console.log(
//                 `  Has "no credentials" comment: ${hasNoCredentialsComment}`,
//             );
