...
//                     c.includes("VPN Server Complete Configuration"),
//                 ),
//             ).toBe(true);
//             expect(
//                 comments.some((c: string) => c.includes("Total VPN Users: 3")),
//             ).toBe(true);
//             expect(
//                 comments.some((c: string) =>
//                     c.includes("WireGuard, OpenVPN, PPTP, L2TP, SSTP, IKEv2"),
//                 ),
//             ).toBe(true);
//         });
...
//             const comments = result[""] || [];
//             expect(
//                 comments.some((c: string) => c.includes("WireGuard: 2 users")),
//             ).toBe(true);
//         });
...
//             expect(
//                 comments.some((c: string) =>
//                     c.includes("No VPN users configured"),
//                 ),
//             ).toBe(true);
//         });
...
//             expect(
//                 comments.some((c: string) =>
//                     c.includes("Configured Protocols:"),
//                 ),
//             ).toBe(true);
//             // Verify the total is still tracked
//             expect(
//                 comments.some((c: string) => c.includes("Total VPN Users: 2")),
//             ).toBe(true);
//         });
//     });
...
//                 () =>
//                     WireguardServerWrapper(
//                         [{ Interface: interfaceConfig, Peers: [] }],
//                         testUsers,
//                     ),
//             );
...
//             expect(
//                 comments.some((c: string) =>
//                     c.includes("WireGuard Server Configuration Summary"),
//                 ),
//             ).toBe(true);
//             expect(comments.some((c: string) => c.includes("Users: 1"))).toBe(
//                 true,
//             ); // Only 1 user has Wireguard VPNType
//         });
...
//             const comments = result[""] || [];
//             expect(comments.some((c: string) => c.includes("Users: 0"))).toBe(
//                 true,
//             );
//         });
//     });
...
//             expect(
//                 comments.some((c: string) =>
//                     c.includes("OpenVPN Server Configuration Summary"),
//                 ),
//             ).toBe(true);
//             expect(comments.some((c: string) => c.includes("Users: 1"))).toBe(
//                 true,
//             ); // Only 1 user has OpenVPN VPNType
//         });
//     });
...
//             expect(
//                 comments.some((c: string) =>
//                     c.includes("PPTP Server Configuration Summary"),
//                 ),
//             ).toBe(true);
//             expect(comments.some((c: string) => c.includes("Users: 1"))).toBe(
//                 true,
//             ); // Only 1 user has PPTP VPNType
//         });
//     });
...
//             expect(
//                 comments.some((c: string) =>
//                     c.includes("L2TP Server Configuration Summary"),
//                 ),
//             ).toBe(true);
//             expect(
//                 comments.some((c: string) => c.includes("IPsec: required")),
//             ).toBe(true);
//             expect(comments.some((c: string) => c.includes("Users: 1"))).toBe(
//                 true,
//             ); // Only 1 user has L2TP VPNType
//         });
//     });
...
//             expect(
//                 comments.some((c: string) =>
//                     c.includes("SSTP Server Configuration Summary"),
//                 ),
//             ).toBe(true);
//             expect(
//                 comments.some((c: string) =>
//                     c.includes("Certificate: server-cert"),
//                 ),
//             ).toBe(true);
//             expect(comments.some((c: string) => c.includes("Users: 1"))).toBe(
//                 true,
//             ); // Only 1 user has SSTP VPNType
//         });
//     });
...
//             expect(
//                 comments.some((c: string) =>
//                     c.includes("IKEv2 Server Configuration Summary"),
//                 ),
//             ).toBe(true);
//             expect(
//                 comments.some((c: string) =>
//                     c.includes("Auth Method: pre-shared-key"),
//                 ),
//             ).toBe(true);
//             expect(comments.some((c: string) => c.includes("Users: 1"))).toBe(
//                 true,
//             ); // Only 1 user has IKeV2 VPNType
//         });
//     });
...
//             expect(
//                 comments.some((c: string) =>
//                     c.includes("No VPN Server configuration provided"),
//                 ),
//             ).toBe(true);
//         });
...
//             const result = WireguardServerWrapper(
//                 [{ Interface: wireguardConfig, Peers: [] }],
//                 [],
//             );
//             validateRouterConfig(result);
...
//                     Username: "multi-user",
//                     Password: "pass",
//                     VPNType: ["Wireguard", "OpenVPN", "PPTP"],
//                 },
//             ];
...
//             const comments = result[""] || [];
//             expect(comments.some((c: string) => c.includes("Users: 2"))).toBe(
//                 true,
//             ); // wg-user and multi-user
//         });
...
//             const comments = result[""] || [];
//             expect(
//                 comments.some((c: string) => c.includes("PPTP: 1 users")),
//             ).toBe(true);
//             expect(
//                 comments.some((c: string) => c.includes("L2TP: 1 users")),
//             ).toBe(true);
//         });
//     });
...
//             expect(
//                 comments.some((c: string) =>
//                     c.includes("WireGuard: 192.168.170.0/24"),
//                 ),
//             ).toBe(true);
//             expect(
//                 comments.some((c: string) =>
//                     c.includes("OpenVPN: 192.168.60.0/24"),
//                 ),
//             ).toBe(true);
//         });
...
//             const vpnServer: VPNServer = {
//                 Users: [
//                     { Username: "user1", Password: "pass1", VPNType: ["SSTP"] },
//                 ],
//                 SstpServer: {
//                     enabled: true,
//                     Certificate: "server-cert",
...
//                 comments.some((c: string) =>
//                     c.includes(
//                         "Certificate management (Let's Encrypt + Private certificates)",
//                     ),
//                 ),
//             ).toBe(true);
//         });
