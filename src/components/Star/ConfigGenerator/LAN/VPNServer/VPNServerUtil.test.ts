...
//             const result = generateVPNServerNetworkConfig(
//                 firewallRules,
//                 addressLists,
//                 interfaceLists,
//             );
...
//             expect(
//                 filterCommands.some((cmd: string) =>
//                     cmd.includes("dst-port=1194,1195"),
//                 ),
//             ).toBe(true);
//             expect(
//                 filterCommands.some((cmd: string) =>
//                     cmd.includes("protocol=tcp,udp"),
//                 ),
//             ).toBe(true);
//         });
...
//             expect(
//                 addressCommands.some((cmd: string) =>
//                     cmd.includes("list=VPN-CLIENTS_2024"),
//                 ),
//             ).toBe(true);
//             expect(
//                 addressCommands.some((cmd: string) =>
//                     cmd.includes("list=PRIVATE-NETWORKS"),
//                 ),
//             ).toBe(true);
//         });
//     });
...
//                 "/interface ovpn-server server set disabled=no",
//             );
...
//             expect(scriptContent).toContain(
//                 "server=$serverName server-address=",
//             );
//             expect(scriptContent).toContain(
...
//             expect(schedulerContent).toContain(
//                 "name=Run-WireGuard-Peer-Update",
//             );
...
//             expect(scriptContent).toContain(
//                 "Processing WireGuard server interface",
//             );
...
//             expect(scriptContent).toContain(
//                 "No WireGuard server interfaces found",
//             );
