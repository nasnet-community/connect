...
export const PublicCert = (): RouterConfig => {
    ...
    const publicCertScriptContent2: RouterConfig = {
        "": [
            ...
            ':log info "$logPrefix Certificates to process: 2 (Google Roots, CA Bundle )";',
            ...
            ':log info ("$logPrefix Certificates processed: " . $successfulCerts . "/2");',
            ':log info ("$logPrefix Certificates verified: " . $verifiedCount . "/2");',
            ...
            "",
            ":if ($verifiedCount = 2) do={",
            '    :log info "$logPrefix [RESULT: SUCCESS] All certificates installed and verified!";',
            "} else={",
            '    :log error ("$logPrefix [RESULT: WARNING] Only " . $verifiedCount . "/2 certificates verified");',
            "}",
            "",
