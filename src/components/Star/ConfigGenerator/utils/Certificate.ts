...
export const PrivateCert = (
    ...
    const privateCertScriptContent: RouterConfig = {
        "": [
            ...
            `    :log info "Detecting router IP for CRL host...";`,
            ...
            `        :log info ("Using router IP for CRL host: " . $crlHost);`,
            `    } else={`,
            `        :log warning "No ethernet IP found, using localhost (127.0.0.1) for CRL host";`,
            `    }`,
            `    `,
