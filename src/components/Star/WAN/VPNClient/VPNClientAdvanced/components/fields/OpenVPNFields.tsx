...
import type { OpenVpnClientConfig } from "~/components/Star/StarContext/Utils/VPNClientType";
        ...
        <>
          ...
          <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div>
              ...
              <Input
                ...
                onInput$={(event: Event, value: string) => {
                  console.log(
                    "[OpenVPNFields] Password updated:",
                    value ? "***" : "(empty)",
                  );
                  onUpdate$({
                    Credentials: {
          ...
          <div>
            ...
            <Input
              ...
              onInput$={(event: Event, value: string) => {
                console.log(
                  "[OpenVPNFields] Key passphrase updated:",
                  value ? "***" : "(empty)",
                );
          ...
          <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div>
              ...
              <Select
                ...
                onChange$={(value: any) => onUpdate$({ Protocol: value })}
                options={[
                  { label: "UDP", value: "udp" },
                  { label: "TCP", value: "tcp" },
                ]}
