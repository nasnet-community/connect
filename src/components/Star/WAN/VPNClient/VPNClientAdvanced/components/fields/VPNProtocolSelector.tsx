                ...
                ${
                  protocol.disabled
                    ...
                    : selectedProtocol === protocol.type
                      ...
                      : "border-gray-200 bg-white hover:scale-105 hover:border-gray-300 hover:shadow-md dark:border-gray-700 dark:bg-gray-800 dark:hover:border-gray-600"
                }
              `}
            >
              {/* Recommended Badge */}
              ...
              {selectedProtocol === protocol.type && (
                <div class="absolute left-3 top-3">
                  <div class="h-3 w-3 animate-pulse rounded-full bg-primary-500 shadow-lg"></div>
                </div>
              )}
