        ...
        <div class="space-y-4">
          ...
          <div>
            ...
            <Input
              ...
              onInput$={(event: Event, value: string) => {
                console.log(
                  "[WireguardFields] InterfacePrivateKey updated:",
                  value,
                );
                onUpdate$({
          ...
          <div>
            ...
            <Input
              ...
              onInput$={(event: Event, value: string) => {
                console.log(
                  "[WireguardFields] InterfaceAddress updated:",
                  value,
                );
                onUpdate$({
          ...
          <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div>
              ...
              <Input
                ...
                onInput$={(event: Event, value: string) => {
                  console.log(
                    "[WireguardFields] PeerEndpointAddress updated:",
                    value,
                  );
                  onUpdate$({
            ...
            <div>
              ...
              <Input
                ...
                onInput$={(event: Event, value: string) => {
                  console.log(
                    "[WireguardFields] PeerEndpointPort updated:",
                    value,
                  );
                  onUpdate$({
