      ...
      <div class="space-y-6">
        ...
        {configMethod.value === "manual" && (
          <FormContainer class="space-y-4 rounded-lg border border-border p-4 dark:border-border-dark">
            <h3 class="text-md text-text-secondary dark:text-text-dark-secondary mb-4 font-medium">
            ...
            <h3 class="text-md text-text-secondary dark:text-text-dark-secondary mb-4 mt-5 font-medium">
            ...
            <p class="text-text-muted dark:text-text-dark-muted mt-4 text-xs">
