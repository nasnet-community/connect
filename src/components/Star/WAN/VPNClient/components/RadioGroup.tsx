...
export const RadioGroup = component$<RadioGroupProps>(({
  ...
  return (
    <div class={`flex ${orientation === "vertical" ? "flex-col space-y-3" : "flex-row space-x-6"} ${className}`}>
      {options.map((option) => (
        <div key={option.value} class="flex items-center">
          ...
          <label
            ...
            class="ml-2 block text-sm font-medium text-text-default dark:text-text-dark-default
