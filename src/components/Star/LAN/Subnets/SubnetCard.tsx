  ...
  ({
    ...
    return (
      <Card
        ...
        ${hasErrors ? "border-red-300 ring-2 ring-red-200 dark:border-red-700 dark:ring-red-800" : styles.border}
        ${disabled ? "opacity-60" : "hover:scale-[1.01] hover:shadow-lg"}
        ${className}
      `}
      >
        ...
        <div class="pointer-events-none absolute inset-0 bg-white/40 backdrop-blur-sm dark:bg-gray-900/40" />
            ...
            <div class="relative z-10 px-6 pb-4">
              ...
              >
                <div class="flex gap-3">
                  <LuAlertTriangle class="mt-0.5 h-5 w-5 flex-shrink-0 text-red-600 dark:text-red-400" />
                  <div class="space-y-1">
                      ...
                      {conflictErrors.map(([key, error]) => {
                        ...
                        return (
                          <li key={key} class="flex items-center gap-2">
                            <span class="h-2 w-2 flex-shrink-0 rounded-full bg-red-500" />
          ...
          <CardBody>
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
              {configs.map((config, index) => (
                <div
                  key={config.key}
                  class="animate-in slide-in-from-bottom-2 group duration-500"
                ...
                <div class="mb-2 text-gray-400 dark:text-gray-600">
                  ...
                  >
                    <path
                      ...
                      stroke-width="2"
                      d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2M4 13h2m10-8l-4 4-4-4"
                    />
                  </svg>
                </div>
