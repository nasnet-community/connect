  ...
  return (
    <div class={`relative ${className}`}>
      <input
        ...
        disabled={disabled}
        class="w-full rounded-md border-border pr-10 shadow-sm 
      ...
      <button
        type="button"
        class="absolute inset-y-0 right-0 flex items-center px-3 text-text-muted hover:text-text-default dark:text-text-dark-muted dark:hover:text-text-dark-default"
