...
export const Select = component$<SelectProps>(
  ({
    ...
    const validationClasses = {
      default:
        "border-border focus:border-primary-500 focus:ring-primary-500 dark:border-border-dark",
      valid:
    ...
    return (
      <div class="relative">
        <select
          ...
          disabled={disabled}
          required={required}
          class={`block w-full rounded-lg border bg-white pl-3 pr-10 ${sizeClasses[size]} ${validationClasses[validation]}
          disabled:bg-surface-lighter dark:disabled:bg-surface-dark-lighter 
          disabled:text-text-muted dark:disabled:text-text-dark-muted appearance-none
