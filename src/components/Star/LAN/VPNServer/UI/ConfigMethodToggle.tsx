...
export const ConfigMethodToggle = component$<ConfigMethodToggleProps>(({
  ...
  return (
    <div class={`flex rounded-lg border border-border dark:border-border-dark ${className}`}>
      <button
        ...
        class={`flex-1 rounded-l-lg px-4 py-2 text-center text-sm font-medium transition-colors
              ${method === "file"
                ...
                : "bg-white text-text-default hover:bg-surface-lighter dark:bg-surface-dark dark:text-text-dark-default dark:hover:bg-surface-dark-lighter"
              }`}
      >
