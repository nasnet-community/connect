...
export const Card = component$<CardProps>(
  ({
      ...
      if (onToggle$) {
        try {
          ...
          if (stepperContext && isProtocolStep) {
            ...
            stepperContext.data.savedStepIndex =
    ...
    const variantClasses = {
      default:
        "border border-border shadow-sm bg-white dark:border-border-dark dark:bg-surface-dark",
      bordered:
        "border-2 border-border-emphasis bg-white dark:border-border-dark-emphasis dark:bg-surface-dark",
      elevated:
        "border border-border shadow-md bg-white dark:border-border-dark dark:bg-surface-dark",
    };
      ...
      <div class={cardClasses}>
        ...
        <div class="flex items-center justify-between border-b border-border px-5 py-4 dark:border-border-dark">
          <div class="flex items-center gap-3">
            {icon && (
              <div class="text-primary-500 dark:text-primary-400">{icon}</div>
            )}
