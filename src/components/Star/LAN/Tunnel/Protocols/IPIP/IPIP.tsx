...
export const IPIPProtocol = component$(() => {
  ...
  const updateTunnelField$ = $((index: number, field: keyof IpipTunnelConfig, value: string | boolean | number | undefined) => {
    updateTunnelField(index, field, value);
  });

  return (
    <div class="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
      <div class="flex cursor-pointer items-center justify-between p-6" onClick$={() => toggleSection$('ipip')}>
                  ...
                  <div>
                    ...
                    >
                      ...
                      {Array.from({ length: 64 }, (_, i) => (
                        <option key={i} value={i.toString()}>{i.toString()}</option>
                      ))}
                    </select>
                  </div>
