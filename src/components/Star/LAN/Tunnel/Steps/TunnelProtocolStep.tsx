...
import { HiLockClosedOutline, HiGlobeAltOutline, HiServerOutline, HiCubeOutline } from "@qwikest/icons/heroicons";
      ...
      <div class="mx-auto max-w-3xl grid grid-cols-2 gap-6">
        {TUNNEL_PROTOCOLS.map((protocol) => {
          ...
          return (
            <div 
              key={protocol.id}
              class="group relative flex flex-col overflow-hidden rounded-xl bg-white border border-gray-100 transition-all duration-200 hover:border-primary-200 hover:shadow-sm dark:bg-gray-800 dark:border-gray-700 dark:hover:border-primary-700 h-full"
            >
              {/* Card Icon */}
              ...
              {/* Card Content */}
              <div class="relative flex h-full flex-col p-5 z-10">
                <h4 class="mb-2 text-lg font-medium text-gray-900 transition-colors duration-200 group-hover:text-primary-600 dark:text-white dark:group-hover:text-primary-400">{protocol.name}</h4>
