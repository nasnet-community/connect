    ...
    const getAvailableBands = () => {
      ...
      for (const routerModel of allRouters) {
        ...
        const wirelessInterfaces =
          routerModel.Interfaces.Interfaces.wireless || [];
                ...
                <div class="space-y-3">
                  ...
                  <div class="space-y-2 pt-2">
                    <div class="text-text-secondary/80 dark:text-text-dark-secondary/85 flex items-center text-sm">
                      <svg
                        class="mr-2 h-4 w-4 text-primary-500 dark:text-primary-400"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                      >
            ...
            <div
              ...
              ${
                props.selectedBand === "5G"
                  ? "bg-secondary-500/5 ring-2 ring-secondary-500 dark:bg-secondary-500/10"
                  : "hover:bg-surface-secondary/50 dark:hover:bg-surface-dark-secondary/60 bg-surface/50 dark:bg-surface-dark/50"
              }`}
            >
              {/* Selected indicator badge */}
              ...
              <div class="space-y-4 p-5">
                ...
                <div class="space-y-3">
                  ...
                  <div class="space-y-2 pt-2">
                    <div class="text-text-secondary/80 dark:text-text-dark-secondary/85 flex items-center text-sm">
                      <svg
                        class="mr-2 h-4 w-4 text-secondary-500 dark:text-secondary-400"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                      >
