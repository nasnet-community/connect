...
export const RouterCardCapabilities = component$<RouterCardCapabilitiesProps>(
  (props) => {
          ...
          {compactCapabilities.map((cap) => {
            ...
            return (
              ...
              >
                <div
                  class={`
                  relative flex items-center gap-1 rounded-full bg-gradient-to-r px-2
                  py-1 ${cap.gradient} 
                  transform transition-all duration-300
                  before:absolute before:inset-0
                  before:scale-0 before:rounded-full before:bg-white/20
                  before:blur-sm before:transition-transform
                  before:duration-300 hover:scale-110 hover:shadow-lg
                  hover:before:scale-100
                `}
                >
                  <Icon class="h-3 w-3 animate-pulse-slow text-white" />
                ...
                <div
                  ...
                  transition-opacity duration-300 group-hover/cap:opacity-50
                `}
                />
              </div>
            );
        ...
        {capabilities.map((cap) => {
          ...
          return (
            <div
              key={cap.label}
              class={`
              group/cap relative overflow-hidden rounded-lg
              ${isEnabled ? "cursor-default" : "cursor-not-allowed opacity-40"}
            `}
            >
              {/* Background gradient */}
              <div
                ...
                opacity-10 transition-opacity duration-300 group-hover/cap:opacity-20
              `}
              />
              ...
              <div class="relative flex items-center gap-2 px-3 py-2">
                <div
                  ...
                  transform transition-all duration-300
                  ${isEnabled ? "group-hover/cap:rotate-3 group-hover/cap:scale-110" : ""}
                `}
                >
                ...
                <div class="flex-1">
                  ...
                  <p class="text-text-secondary/70 dark:text-text-dark-secondary/70 text-xs">
              ...
              {isEnabled && (
                <div
                  ...
                  w-0 transition-all duration-500 group-hover/cap:w-full
                `}
                />
              )}
            </div>
