...
export const NetworkTopologyDiagram = component$<NetworkTopologyDiagramProps>(
  (props) => {
    const { router } = props;
    ...
    const hasVPN =
      router.networkCapabilities?.vpnProtocols &&
      router.networkCapabilities.vpnProtocols.length > 0;
    ...
    return (
      <div class="relative w-full">
        ...
        >
          ...
          <defs>
            ...
            >
              <path
                ...
                stroke="currentColor"
                stroke-width="0.5"
                class="text-border/10 dark:text-border-dark/10"
              />
            </pattern>
            ...
            >
              <stop
                offset="0%"
                style="stop-color:rgb(236, 72, 153);stop-opacity:1"
              />
              <stop
                offset="100%"
                style="stop-color:rgb(239, 68, 68);stop-opacity:1"
              />
            </linearGradient>
          </defs>
          ...
          >
            {router.networkCapabilities?.throughput || "N/A"} Throughput •{" "}
            {router.networkCapabilities?.maxConnections || "N/A"} Max
            Connections
          </text>
        </svg>
      </div>
