...
export const RouterSelectionSection = component$<RouterSelectionSectionProps>(
  (props) => {
            ...
            >
              ...
              <div class="relative flex h-full flex-col p-5 sm:p-6">
                ...
                <div class="mt-4 space-y-2 text-center">
                  <h3 class="text-xl font-semibold text-text transition-colors duration-300 group-hover:text-primary-500 dark:text-text-dark-default dark:group-hover:text-primary-400">
