  ...
  ({
    ...
    > = {
      primary: {
        ...
        activeSegment:
          "bg-primary-500 text-white shadow-md dark:bg-primary-600 dark:text-primary-50",
        inactiveSegment:
          "text-primary-900 hover:text-primary-800 dark:text-primary-300 dark:hover:text-primary-200",
      ...
      secondary: {
        ...
        activeSegment:
          "bg-secondary-500 text-white shadow-md dark:bg-secondary-600 dark:text-secondary-50",
        inactiveSegment:
          "text-secondary-900 hover:text-secondary-800 dark:text-secondary-300 dark:hover:text-secondary-200",
        activeText: "text-white font-semibold",
        ...
        >
          {options.map((option, index) => {
            ...
            const segmentClass = [
              ...
              fullWidth ? "flex-1" : "",
              isSelected
                ? [colorCfg.activeSegment, "transform scale-[1.02]"].join(" ")
                : [
