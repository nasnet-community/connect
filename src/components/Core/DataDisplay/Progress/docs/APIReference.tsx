...
export default component$(() => {
  const progressBarProps = [
    {
      name: 'value',
      type: 'number',
      description: 'Current value of the progress. Should be between min and max.'
    },
    {
      name: 'min',
      type: 'number',
    ...
    },
    {
      name: 'buffer',
      type: 'number',
      description: 'Buffer value for operations with a preparatory phase (like video buffering).'
    },
    {
      name: 'size',
      type: "'xs' | 'sm' | 'md' | 'lg'",
    ...
    },
    {
      ...
      defaultValue: 'none',
      description: 'Animation applied to the filled portion of the progress bar.'
    },
    {
      name: 'showValue',
      type: 'boolean',
  ...
  const spinnerProps = [
    ...
    },
    {
      ...
      type: 'number',
      defaultValue: '0.75',
      description: 'Animation speed in seconds for one complete rotation or animation cycle.'
    },
    {
      name: 'showLabel',
      type: 'boolean',
  ...
  return (
    <APIReferenceTemplate props={progressBarProps}>
      <h2 class="text-xl font-semibold mb-4">Progress Components API</h2>
      <p class="mb-6">
        The Progress module exports two main components: ProgressBar and Spinner, each with their own set of props
        and customization options. Both components are designed to provide visual feedback for operations
        with different loading patterns.
      </p>
      
      <h3 class="text-lg font-semibold mt-6 mb-2">ProgressBar Props</h3>
      <p class="mb-4">
        The ProgressBar component shows the completion progress of an operation, typically displayed as a
        horizontal bar that fills as the operation progresses.
      </p>
      
      <h3 class="text-lg font-semibold mt-8 mb-2">Spinner Props</h3>
      ...
      <ul class="list-disc list-inside ml-4 mb-4">
        <li><code>ProgressBar</code> - Main progress bar component</li>
        <li><code>Spinner</code> - Loading spinner component</li>
        <li><code>useProgressBar</code> - Hook for custom progress bar implementations</li>
        <li><code>useSpinner</code> - Hook for custom spinner implementations</li>
