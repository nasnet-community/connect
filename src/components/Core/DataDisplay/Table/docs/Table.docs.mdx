...
import { Table } from '~/components/Core/DataDisplay/Table';
...
import { Table, SortState } from '~/components/Core/DataDisplay/Table';
  ...
  return (
    <Table
      ...
      columns={[
        ...
        { id: 'status', header: 'Status', field: 'status', hideOn: { md: true } },
      ]}
...
```tsx
import { component$ } from '@builder.io/qwik';
import { TableHead, TableBody, TableRow, TableCell } from '~/components/Core/DataDisplay/Table';
