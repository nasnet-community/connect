...
- <kbd>Space</kbd> / <kbd>Enter</kbd>: Toggle the currently focused accordion item
- <kbd>Home</kbd>: Move focus to the first accordion item (when implemented with keyboard handling)
- <kbd>End</kbd>: Move focus to the last accordion item (when implemented with keyboard handling)
