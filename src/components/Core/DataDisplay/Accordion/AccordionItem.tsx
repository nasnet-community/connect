import { component$, Slot, useContext, useContextProvider } from '@builder.io/qwik';
...
export const AccordionItem = component$<AccordionItemProps>((props) => {
  ...
  const variantClasses = {
    default: '',
    bordered: '',
    separated: 'border border-gray-200 dark:border-gray-700 rounded-md overflow-hidden',
