...
export default component$(() => {
  const listProps = [
    ...
    },
    {
      ...
      type: 'boolean',
      defaultValue: 'false',
      description: 'For ordered lists, whether the list should be displayed in reverse order.'
    },
    {
      name: 'class',
      type: 'string',
  ...
  const listItemProps = [
    ...
    },
    {
      ...
      type: 'boolean',
      defaultValue: 'false',
      description: 'Whether the list item is disabled (reduces opacity and removes interactivity).'
    },
    {
      name: 'value',
      type: 'string',
      description: 'Provides an explicit value for the list item (useful for accessibility).'
    },
    {
      name: 'class',
      type: 'string',
  ...
  return (
    <APIReferenceTemplate props={listProps}>
      <p>
        ...
        subcomponents: ListItem, ListTerm, and ListDescription.
        Each component has its own set of props to control its appearance and behavior.
      </p>
      
      <h3 class="text-lg font-semibold mt-6 mb-2">ListItem Props</h3>
      <APIReferenceTemplate props={listItemProps} />
      
      <h3 class="text-lg font-semibold mt-6 mb-2">ListTerm Props</h3>
      <APIReferenceTemplate props={listTermProps} />
      
      <h3 class="text-lg font-semibold mt-6 mb-2">ListDescription Props</h3>
      <APIReferenceTemplate props={listDescriptionProps} />
      
      <h3 class="text-lg font-semibold mt-6 mb-2">Component Exports</h3>
      <p class="mb-2">The List module exports the following components:</p>
      <ul class="list-disc list-inside ml-4 mb-4">
        <li><code>List</code> - Base list component</li>
        <li><code>ListItem</code> - Individual list item</li>
        <li><code>ListTerm</code> - Term in a definition list</li>
        <li><code>ListDescription</code> - Description in a definition list</li>
        <li><code>UnorderedList</code> - Convenience component for unordered lists</li>
        <li><code>OrderedList</code> - Convenience component for ordered lists</li>
        <li><code>DefinitionList</code> - Convenience component for definition lists</li>
      </ul>
      
      <p>
        The convenience components (UnorderedList, OrderedList, DefinitionList) are wrappers 
        around the base List component with the variant property pre-set for easier usage.
      </p>
