...
export default component$(() => {
  const tooltipProps = [
    {
      ...
      description: 'The content to display in the tooltip. Can be a simple string or JSX content.'
    },
    {
      name: 'children',
      type: 'JSXChildren',
    ...
    },
    {
      ...
      type: "'sm' | 'md' | 'lg'",
      defaultValue: 'md',
      description: 'The size of the tooltip which affects padding and font size.'
    },
    {
      name: 'color',
    ...
    },
    {
      name: 'visible',
      type: 'boolean',
      description: 'Manually control the visibility of the tooltip (makes it a controlled component).'
    },
    {
    ...
    },
    {
      ...
      type: 'boolean',
      defaultValue: 'false',
      description: 'When true, the tooltip can be interacted with without disappearing.'
    },
    {
      name: 'maxWidth',
      type: 'string',
  ...
  return (
    <APIReferenceTemplate props={tooltipProps}>
      <p>
        The Tooltip component provides a flexible way to display additional information or context when a user
        interacts with an element. It consists of several subcomponents that work together to create a complete tooltip experience.
      </p>
      
      <h3 class="text-lg font-semibold mt-8 mb-2">Component Structure</h3>
      <p class="mb-4">
        While you'll typically use the main <code>Tooltip</code> component for most use cases, the tooltip system
        consists of several subcomponents that handle specific aspects of the tooltip:
      </p>
      <ul class="list-disc list-inside ml-4 mb-4">
        <li><code>Tooltip</code> - The main component that wraps everything together</li>
        <li><code>TooltipTrigger</code> - Handles the element that triggers the tooltip</li>
        <li><code>TooltipContent</code> - The tooltip content container</li>
        <li><code>TooltipArrow</code> - The arrow pointing from the tooltip to the trigger</li>
      </ul>
      
      <h3 class="text-lg font-semibold mt-8 mb-2">TooltipTrigger Props</h3>
      <APIReferenceTemplate props={tooltipTriggerProps} />
      
      <h3 class="text-lg font-semibold mt-8 mb-2">TooltipContent Props</h3>
      ...
      <ul class="list-disc list-inside ml-4 mb-4">
        <li><code>TooltipPlacement</code> - Placement options for the tooltip</li>
        <li><code>TooltipTriggerType</code> - Trigger types: 'hover' | 'click' | 'focus' | 'manual'</li>
        <li><code>TooltipSize</code> - Size options: 'sm' | 'md' | 'lg'</li>
        <li><code>TooltipColor</code> - Color variants: 'default' | 'primary' | 'secondary' | 'success' | 'warning' | 'error' | 'info'</li>
      </ul>
      
      <h3 class="text-lg font-semibold mt-8 mb-2">Hook: useTooltip</h3>
      <p class="mb-2">
        The <code>useTooltip</code> hook provides low-level control for custom tooltip implementations:
      </p>
      <pre class="p-4 bg-neutral-100 dark:bg-neutral-800 rounded-md mb-4 overflow-x-auto">
        <code>
{`import { useTooltip } from '~/components/Core/DataDisplay/Tooltip';
