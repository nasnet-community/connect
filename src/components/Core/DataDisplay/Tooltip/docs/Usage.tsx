  ...
  const doSection = [
    {
      ...
      description: 'Tooltips should provide additional context or explanation that enhances the user experience without being essential for basic functionality.',
...
<Tooltip content="Edit profile settings">
  <IconButton icon={GearIcon} aria-label="Settings" />
    ...
    },
    {
      ...
      description: 'Tooltips should be brief and to the point. For longer content, consider using a popover or modal instead.',
...
<Tooltip content="This will copy the entire contents of the document to your system clipboard so that you can paste it into another application. If the document is protected, you will need administrator permission to complete this action.">
  <IconButton icon={ClipboardIcon} aria-label="Copy" />
    ...
    },
    {
      ...
      description: 'Ensure tooltips are accessible by including proper ARIA attributes and supporting keyboard navigation.',
...
<Tooltip content="Add a new item">
  ...
  />
    ...
    },
    {
      ...
      description: 'Choose appropriate tooltip placement to ensure they are visible and don\'t obscure important content.',
  ...
  const dontSection = [
    {
      ...
      description: 'Don\'t hide critical information or primary instructions in tooltips. Essential information should be visible at all times.',
...
<form>
  ...
  <Button>Submit</Button>
    ...
    },
    {
      ...
      description: 'Avoid including complex interactive elements within tooltips. For interactive content, use a popover or modal instead.',
...
>
  <IconButton icon={GearIcon} aria-label="Settings" />
    ...
    },
    {
      ...
      description: 'Tooltips triggered by hover aren\'t suitable for mobile interfaces. Consider alternatives like labels or info icons that trigger tooltips on tap.',
...
<div class="mobile-app-interface">
  <Card>
    ...
    },
    {
      ...
      description: 'Too many tooltips can clutter the interface and decrease their effectiveness. Use them sparingly for truly supplementary information.',
...
<div>
  ...
  return (
    <UsageTemplate
      mainDescription="Tooltips provide supplementary information when users hover over, focus on, or click an element. They help clarify unfamiliar concepts, explain functionality, or provide additional context without cluttering the interface."
      doSection={doSection}
    ...
    >
      <h3 class="text-lg font-medium mt-6 mb-2">Common Use Cases</h3>
      <ul class="list-disc ml-6 mb-4 space-y-2">
        <li>
          <strong>Explaining UI controls:</strong> Use tooltips to explain what an icon button or control does,
          especially for actions with limited space for labels.
        </li>
        <li>
          <strong>Form field guidance:</strong> Provide additional information about form fields,
          such as input format requirements or field purpose.
        </li>
        <li>
          <strong>Abbreviated content:</strong> Show full text for truncated content or elements
          that have been shortened due to space constraints.
        </li>
        <li>
          <strong>Feature discovery:</strong> Highlight new or important features to users
          without disrupting their workflow.
        </li>
        <li>
          <strong>Help text:</strong> Provide contextual help for specific elements without
          requiring users to navigate away from their current task.
        </li>
      </ul>
      
      <h3 class="text-lg font-medium mt-6 mb-2">Tooltip Triggers</h3>
      <p class="mb-2">Choose the appropriate trigger method based on context:</p>
      <ul class="list-disc ml-6 mb-4">
        <li>
          <strong>Hover:</strong> The default behavior - best for desktop applications when
          additional information is supplementary.
        </li>
        <li>
          <strong>Focus:</strong> Important for accessibility - ensures keyboard users can
          access tooltip information.
        </li>
        <li>
          <strong>Click:</strong> Better for mobile interfaces or when the tooltip contains
          important information that shouldn't be missed.
        </li>
        <li>
          <strong>Combined triggers:</strong> Often best to use multiple triggers, such as
