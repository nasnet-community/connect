...
import type { DocumentationIndexProps } from '~/components/Docs/templates';
...
export const useDocumentationLoader = routeLoader$<DocumentationIndexProps>(() => {
  return {
    ...
    githubLink: 'https://github.com/your-org/connect/tree/main/src/components/Core/DataDisplay/Tooltip',
