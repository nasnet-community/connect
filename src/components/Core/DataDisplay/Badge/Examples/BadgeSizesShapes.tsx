...
export const BadgeSizesShapes = component$(() => {
  return (
    <div class="flex flex-col gap-6">
      <div>
        <h3 class="text-sm font-medium mb-2">Badge Sizes</h3>
      ...
      <div>
        <h3 class="text-sm font-medium mb-2">Badge Shapes</h3>
        <div class="flex items-center gap-3">
      ...
      <div>
        <h3 class="text-sm font-medium mb-2">Badge with Icons</h3>
        <div class="flex items-center gap-3">
          <Badge color="success">
            <span class="mr-1">
      ...
      <div>
        <h3 class="text-sm font-medium mb-2">Badge Group</h3>
        <BadgeGroup>
