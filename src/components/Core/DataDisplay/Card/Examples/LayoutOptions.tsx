  ...
  return (
    <div class="p-4">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <h3 class="text-sm font-semibold mb-2">Full Width Card</h3>
          <Card 
            fullWidth={true} 
            variant="outlined"
          >
        ...
        <div>
          <h3 class="text-sm font-semibold mb-2">Card with Fixed Width</h3>
          <Card 
            class="w-64"
            variant="outlined"
          >
      ...
      <div class="mt-6 grid grid-cols-1 gap-4">
        <div>
          <h3 class="text-sm font-semibold mb-2">Full Height Card in Container</h3>
          <div class="h-48 border border-dashed border-gray-300 dark:border-gray-700 rounded-md p-4">
            <Card 
              fullHeight={true} 
              variant="outlined"
