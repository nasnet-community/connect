...
export default component$(() => {
  return (
    <div class="p-4">
      ...
      >
        <CardHeader>
          <h3 id="card-heading" class="text-lg font-medium">Accessible Card</h3>
        </CardHeader>
        <CardBody>
          <p id="card-description" class="text-sm text-gray-600 dark:text-gray-300">
            This card demonstrates proper accessibility implementation. It has proper ARIA
            attributes connecting the card to its heading and description. The interactive
            card can be navigated to with keyboard and activated with Enter or Space.
          </p>
