...
export default component$(() => {
      ...
      <div class="p-4 border rounded-md">
        ...
        >
          {props.Content.includeHeader && (
            <CardHeader bordered={props.Content.headerBordered} compact={props.Content.compact}>
          ...
          {props.Content.includeFooter && (
            <CardFooter bordered={props.Content.footerBordered} compact={props.Content.compact}>
  ...
  return (
    ...
    >
      <p>
        Use this playground to experiment with the Card component. 
        Adjust the properties to see how different configurations affect the 
        appearance and behavior of the card.
      </p>
    </PlaygroundTemplate>
  );
});
