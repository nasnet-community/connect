  ...
  const cardProps = [
    {
      name: 'children',
      type: 'JSXChildren',
      description: 'Card content. Typically includes CardHeader, CardBody, CardFooter and/or CardMedia components.'
    },
    {
      name: 'class',
      type: 'string',
    ...
    },
    {
      ...
      type: 'boolean',
      defaultValue: 'false',
      description: 'Whether the card can be interacted with (clicked, focused).'
    },
    {
      name: 'fullHeight',
      type: 'boolean',
      defaultValue: 'false',
      description: 'Whether the card should take up the full height of its container.'
    },
    {
      name: 'fullWidth',
      type: 'boolean',
    ...
    },
    {
      ...
      type: 'boolean',
      defaultValue: 'false',
      description: 'Whether the card is disabled (reduces opacity and removes interactivity).'
    },
    {
      name: 'bgColor',
      type: 'string',
      description: 'Custom background color for the card. Can be any valid CSS color value.'
    },
    {
      name: 'borderColor',
      type: 'string',
      description: 'Custom border color for the card. Can be any valid CSS color value.'
    },
    {
      name: 'href',
      type: 'string',
    ...
    },
    {
      ...
      type: 'string',
      defaultValue: 'div',
      description: 'HTML element to render the card as (e.g., "section", "article").'
    },
    {
      name: 'onClick$',
  ...
  return (
    <APIReferenceTemplate props={cardProps}>
      <p>
        ...
        subcomponents: CardHeader, CardBody, CardFooter, and CardMedia.
        Each component has its own set of props to control its appearance and behavior.
      </p>
      
      <h3 class="text-lg font-semibold mt-6 mb-2">CardHeader Props</h3>
      <APIReferenceTemplate props={cardHeaderProps} />
      
      <h3 class="text-lg font-semibold mt-6 mb-2">CardBody Props</h3>
      <APIReferenceTemplate props={cardBodyProps} />
      
      <h3 class="text-lg font-semibold mt-6 mb-2">CardFooter Props</h3>
      <APIReferenceTemplate props={cardFooterProps} />
      
      <h3 class="text-lg font-semibold mt-6 mb-2">CardMedia Props</h3>
