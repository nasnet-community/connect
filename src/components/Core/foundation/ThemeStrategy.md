...
```jsx
<div class="bg-white dark:bg-surface-dark text-text-default dark:text-text-dark-default">
...
```jsx
<div class="bg-white dark:bg-surface-dark rounded-lg shadow-md dark:shadow-sm border border-border dark:border-border-dark">
  <div class="p-4 border-b border-border dark:border-border-dark">
    <h3 class="text-lg font-semibold text-text-default dark:text-text-dark-default">Card Title</h3>
  </div>
  <div class="p-4">
    <p class="text-text-secondary dark:text-text-dark-secondary">Card content with proper dark mode styling</p>
  </div>
</div>
```
