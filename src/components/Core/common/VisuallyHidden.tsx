...
export const VisuallyHidden = component$<VisuallyHiddenProps>((props) => {
  ...
  const focusClasses = focusable
    ? classNames(
        ...
        focusPosition === "top-right" &&
          "focus:absolute focus:top-4 focus:right-4 focus:z-50",
        focusPosition === "top-center" &&
          "focus:absolute focus:top-4 focus:left-1/2 focus:-translate-x-1/2 focus:z-50",
        focusPosition === "center" &&
          "focus:fixed focus:top-1/2 focus:left-1/2 focus:-translate-x-1/2 focus:-translate-y-1/2 focus:z-50",
  ...
  const combinedClasses = classNames(baseClasses, focusClasses, className);
