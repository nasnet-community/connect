...
export default component$(() => {
  ...
  return (
    <div class="space-y-8">
      <div>
        <h3 class="text-sm font-semibold mb-3">Default State</h3>
        <RadioGroup
          options={[
      ...
      <div>
        <h3 class="text-sm font-semibold mb-3">Required State</h3>
        <RadioGroup
          options={[
            { value: 'option1', label: 'Option 1' },
            { value: 'option2', label: 'Option 2' },
      ...
      <div>
        <h3 class="text-sm font-semibold mb-3">Disabled State (Group)</h3>
        <RadioGroup
          options={[
            { value: 'option1', label: 'Option 1' },
            { value: 'option2', label: 'Option 2' },
      ...
      <div>
        <h3 class="text-sm font-semibold mb-3">Disabled Options</h3>
        <RadioGroup
          options={[
            { value: 'option1', label: 'Option 1' },
      ...
      <div>
        <h3 class="text-sm font-semibold mb-3">Error State</h3>
        <RadioGroup
          options={[
            { value: 'option1', label: 'Option 1' },
            { value: 'option2', label: 'Option 2' },
