...
export default component$(() => {
  const checkboxProps: PropDetail[] = [
    ...
    },
    {
      name: "onValueChange$",
      type: "QRL<(checked: boolean) => void>",
      description: "Alternative callback for state changes, allows integration with different state patterns",
    },
    {
      name: "label",
      type: "string",
    ...
    },
    {
      ...
      type: "boolean",
      defaultValue: "false",
      description: "Whether to render just the checkbox input without the label container",
    },
    {
      name: "indeterminate",
      type: "boolean",
  ...
  const checkboxGroupProps: PropDetail[] = [
    ...
    },
    {
      ...
      description: "Callback with the complete array of selected values when selection changes",
    },
    {
      name: "label",
      type: "string",
    ...
    },
    {
      name: "helperText",
      type: "string",
      description: "Additional information text displayed below the group label",
    },
    {
      name: "error",
      type: "string",
  ...
  return (
    ...
    >
      <p>
        The Checkbox component is used for boolean selection options in forms. It can be used as a 
        standalone component or as part of a CheckboxGroup for multiple related options.
      </p>
      <p class="mt-3">
        In addition to the standard checkbox functionality, this component provides features like indeterminate
        state support, different sizes, and robust accessibility attributes.
      </p>
      
      <h3 class="text-lg font-medium mt-8 mb-4">CheckboxGroup Props</h3>
      <table class="w-full border-collapse">
        ...
        <tbody>
          {checkboxGroupProps.map((prop) => (
            <tr key={prop.name} class="border-b border-border dark:border-border-dark">
              ...
              <td class="py-2 px-4 font-mono text-sm">{prop.defaultValue || '-'}</td>
