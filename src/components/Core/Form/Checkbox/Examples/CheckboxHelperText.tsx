...
export default component$(() => {
  ...
  return (
    <div class="space-y-6">
      <div>
        <h3 class="text-sm font-semibold mb-2">Checkbox with Helper Text</h3>
        <Checkbox 
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">Checkbox with Required Field</h3>
        <Checkbox 
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">Inline Checkbox</h3>
        <div class="flex items-center gap-2">
          ...
          />
          <span class="text-sm">This checkbox has no built-in label (using inline mode)</span>
        </div>
      </div>
    </div>
  );
