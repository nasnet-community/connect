...
// Color themes
export type PrefixedInputColor =
  | "default"
  | "primary"
  | "success"
  | "warning"
...
export interface PrefixedInputProps
  extends Omit<InputProps, "value" | "onChange$" | "size" | "type"> {
...
export interface InterfaceNameInputProps
  extends Omit<PrefixedInputProps, "prefix" | "type"> {
