...
export const PrefixedInput = component$<PrefixedInputProps>(
  ({
    ...
    const animationConfig = animate
      ...
      : { transition: "", focus: "", hover: "", loading: "" };
      ...
      <div class="space-y-2">
        ...
        >
          ...
          {copyable && value && (
            <button
              type="button"
              class="rounded px-3 text-xs font-medium text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-700 dark:hover:bg-gray-700 dark:hover:text-gray-300"
              onClick$={handleCopy$}
