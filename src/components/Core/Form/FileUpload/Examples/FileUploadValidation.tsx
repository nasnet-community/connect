...
export default component$(() => {
  ...
  return (
    <div class="space-y-8">
      <div>
        <h3 class="text-sm font-semibold mb-2">Accept Images Only</h3>
        <FileUpload
          label="Upload images"
          accept="image/*"
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">Accept Specific File Types</h3>
        <FileUpload
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">Maximum File Size</h3>
        <FileUpload
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">Custom File Validation</h3>
        <FileUpload
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">Maximum Number of Files</h3>
        <FileUpload
