...
export default component$(() => {
  ...
  return (
    <div class="space-y-8">
      <div>
        <h3 class="text-sm font-semibold mb-2">Auto Upload Mode</h3>
        <FileUpload
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">With Preview</h3>
        <FileUpload
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">Manual Upload with Button</h3>
        <FileUpload
          label="Manual upload"
          showUploadButton
          showProgress
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">Complete File Management</h3>
        <FileUpload
