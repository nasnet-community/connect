...
export default component$(() => {
  return (
    <div class="space-y-8">
      <div>
        <h3 class="text-sm font-semibold mb-2">Horizontal Layout (Default)</h3>
        <FileUpload
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">Vertical Layout</h3>
        <FileUpload
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">Customized Drop Area Text</h3>
        <FileUpload
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">Custom Styling</h3>
        <FileUpload
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">Without Drag and Drop</h3>
        <FileUpload
