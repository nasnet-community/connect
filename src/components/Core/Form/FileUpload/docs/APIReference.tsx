...
export default component$(() => {
  const props: PropDetail[] = [
    ...
    },
    {
      name: "value",
      type: "FileInfo[]",
      description: "Controlled value containing array of file information objects"
    },
    {
      name: "defaultValue",
      type: "FileInfo[]",
    ...
    },
    {
      ...
      type: "boolean",
      defaultValue: "true",
      description: "Whether to show the upload button (only applied when autoUpload is false)"
    },
    {
    ...
    },
    {
      ...
      description: "Custom validation function that returns true if valid or an error message if invalid"
    },
    ...
    },
    {
      ...
      defaultValue: "'default'",
      description: "State of the file upload component, affecting its appearance"
    },
    {
    ...
    },
    {
      ...
      description: "Template for the selected files count text, {count} will be replaced with the actual count"
    },
    {
      name: "dragAndDrop",
      type: "boolean",
  ...
  return (
    ...
    >
      <p>
        The FileUpload component provides a comprehensive interface for file selection and uploading,
        with extensive customization options for appearance, behavior, and validation.
      </p>
      <p class="mt-3">
        The component supports both controlled and uncontrolled usage patterns. For controlled usage,
        provide the value prop and handle file selection via callbacks. The FileInfo type represents
        files with additional metadata for tracking upload status.
      </p>
      <p class="mt-3">
        File validation can be performed using built-in options like maxFileSize and accept, or with
        custom validation through the validateFile$ prop. For handling the actual upload process,
        you can use the built-in uploader with uploadUrl or provide a customUploader$ function.
      </p>
    </APIReferenceTemplate>
  );
}); 