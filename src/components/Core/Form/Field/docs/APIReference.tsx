...
export default component$(() => {
  ...
  return (
    ...
    >
      <p>
        The Field component provides a standardized interface for input fields. It supports various input types, 
        validation states, and customization options to create consistent form fields throughout your application.
      </p>
      <p class="mt-3">
        The Field component is designed to work both as a standalone component and in conjunction with the Form component 
        for more complex form handling. It provides appropriate aria attributes and styling based on the field's state.
      </p>
    </APIReferenceTemplate>
  );
}); 