...
export default component$(() => {
  ...
  return (
    <div class="space-y-6">
      <div>
        <h3 class="text-sm font-semibold mb-2">Text Field</h3>
        <Field
          type="text"
          label="Text input"
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">Email Field</h3>
        <Field
          type="email"
          label="Email input"
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">Number Field</h3>
        <Field
          type="number"
          label="Number input"
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">Password Field</h3>
        <Field
          type="password"
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">Date Field</h3>
        <Field
          type="date"
          label="Date input"
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">Checkbox Field</h3>
        <Field
          type="checkbox"
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">Radio Field</h3>
        <Field
          type="radio"
