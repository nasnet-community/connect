...
export default component$(() => {
  ...
  return (
    <div class="space-y-6">
      <div>
        <h3 class="text-sm font-semibold mb-2">Small Size Field</h3>
        <Field
          size="sm"
          label="Small input"
          type="text"
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">Medium Size Field (Default)</h3>
        <Field
          size="md"
          label="Medium input"
          type="text"
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">Large Size Field</h3>
        <Field
          size="lg"
          label="Large input"
          type="text"
