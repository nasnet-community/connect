...
export default component$(() => {
  const commonProps: PropDetail[] = [
    ...
    },
    {
      name: "markCount",
      type: "number",
      description: "Number of marks to auto-generate when marks array is not provided",
      defaultValue: "0"
    },
    {
      name: "showTicks",
  ...
  return (
    ...
    >
      <p>
        The Slider component provides a way to select numeric values through an interactive track and thumb interface.
        It supports both single value selection and range selection with numerous customization options.
      </p>
      
      <h3 class="text-lg font-medium mt-8 mb-4">Single Slider Props</h3>
      <p class="mb-4">These props are specific to single value sliders (when type is 'single' or not specified).</p>
      ...
      <h3 class="text-lg font-medium mt-8 mb-4">Range Slider Props</h3>
      <p class="mb-4">These props are specific to range sliders (when type is 'range').</p>
      <table class="w-full border-collapse">
        <thead>
          <tr class="border-b border-border dark:border-border-dark">
            <th class="py-2 px-4 text-left">Name</th>
      ...
      <h3 class="text-lg font-medium mt-8 mb-4">Types</h3>
      <div class="p-4 bg-surface-secondary dark:bg-surface-dark-secondary rounded font-mono text-sm mb-4">
        <pre>{`
