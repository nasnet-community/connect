...
export default component$(() => {
  ...
  return (
    <div class="space-y-8 max-w-xl">
      ...
      <div>
        <h3 class="text-sm font-medium mb-2">Read-only State</h3>
        <Slider
      ...
      <div>
        <h3 class="text-sm font-medium mb-2">Success State</h3>
        <Slider
          label="Success State"
          value={80}
          onChange$={$((newValue) => {
      ...
      <div>
        <h3 class="text-sm font-medium mb-2">Warning State</h3>
        <Slider
          label="Warning State"
          value={10}
          onChange$={$((newValue) => {
