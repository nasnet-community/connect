      ...
      <div class="space-y-2">
        ...
        <input
          ...
          class={`block w-full px-3 py-2 border rounded-md
            ${props.disabled ? 'bg-gray-100 dark:bg-gray-800 cursor-not-allowed border-gray-300 dark:border-gray-700' : ''}
        ...
        {props.srOnly && (
          <div class="text-sm text-gray-500 dark:text-gray-400 italic mt-2">
