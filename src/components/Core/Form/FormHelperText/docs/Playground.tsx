...
export default component$(() => {
  ...
  const FormHelperTextDemo = component$<{
    ...
    return (
      <div class="mb-6">
        <div class="pb-2 mb-2 border-b border-gray-200 dark:border-gray-800">
          <span class="text-gray-500 dark:text-gray-400 text-sm font-medium">Form Input (for context)</span>
          <input 
            type="text" 
            class={`mt-1 block w-full px-3 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md
        ...
        {props.srOnly && (
          <div class="mt-4 p-2 bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 text-sm rounded-md">
            <span class="font-medium">Note:</span> The helper text is visually hidden but accessible to screen readers.
          </div>
        )}
      </div>
    );
