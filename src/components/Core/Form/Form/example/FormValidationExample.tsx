    ...
    >
      ...
      <FormField
        ...
        validate={[
          ...
          validators.custom(checkUsernameAvailable)
        ]}
      >
        <input
          type="text"
      ...
      <FormField
        ...
        validate={[
          ...
          validators.custom(validatePasswordStrength)
        ]}
      >
        <input
          type="password"
      ...
      <FormField
        ...
        validate={[
          validators.custom((value) => value === true ? undefined : 'You must agree to the terms and conditions')
        ]}
      >
