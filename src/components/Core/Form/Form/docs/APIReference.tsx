...
export default component$(() => {
  ...
  return (
    ...
    >
      <p>
        The Form component provides a comprehensive API for building and managing forms. It includes props for form configuration,
        methods for form state management, and integration with Qwik City for server actions.
      </p>
      <p class="mt-3">
        Additionally, the Form component provides a context that exposes various methods for interacting with the form state
        from child components. This allows for powerful form composition and custom field implementations.
      </p>
    </APIReferenceTemplate>
  );
}); 