...
export default component$(() => {
  const value = useSignal('Type here and watch the textarea grow as you add more content.\nTry adding multiple lines to see how it expands.');

  return (
    <div class="space-y-6">
      <div>
        <h3 class="text-sm font-semibold mb-2">Auto-resizing TextArea</h3>
        <TextArea 
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">Fixed-height TextArea (for comparison)</h3>
        <TextArea 
