...
export default component$(() => {
  return (
    <div class="space-y-6">
      <div>
        <h3 class="text-sm font-semibold mb-2">No Resize</h3>
        <TextArea 
          label="No Resize"
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">Vertical Resize (Default)</h3>
        <TextArea 
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">Horizontal Resize</h3>
        <TextArea 
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">Both Directions Resize</h3>
        <TextArea 
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">Auto Resize (Browser Default)</h3>
        <TextArea 
