...
export default component$(() => {
  ...
  return (
    <div class="space-y-6">
      <div>
        <h3 class="text-sm font-semibold mb-2">TextArea with Character Count</h3>
        <TextArea 
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">TextArea with Custom Counter Format</h3>
        <TextArea 
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">Character Count without Limit</h3>
        <TextArea 
