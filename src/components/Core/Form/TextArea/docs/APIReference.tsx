...
export default component$(() => {
  const props: PropDetail[] = [
    ...
    },
    {
      ...
      type: "boolean",
      defaultValue: "false",
      description: "Whether to automatically resize the text area based on content",
    },
    {
      name: "resize",
    ...
    },
    {
      ...
      type: "boolean",
      defaultValue: "false",
      description: "Whether the text area should take full width of its container",
    },
    {
      name: "showClear",
      type: "boolean",
  ...
  return (
    ...
    >
      <p>
        The TextArea component is designed for collecting multi-line text input in forms. It extends the
        standard HTML textarea with additional features and capabilities while maintaining a consistent 
        styling and behavior with other form components.
      </p>
      <p class="mt-3">
        This component offers advanced features like auto-resizing, character counting, various resize 
        behaviors, and robust validation state handling. It's built to be accessible and integrate seamlessly
        with both controlled and uncontrolled form patterns.
      </p>
    </APIReferenceTemplate>
  );
}); 