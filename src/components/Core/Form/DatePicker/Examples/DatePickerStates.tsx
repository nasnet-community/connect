...
export default component$(() => {
  ...
  return (
    <div class="space-y-6">
      <div>
        <h3 class="text-sm font-semibold mb-2">Required DatePicker</h3>
        <DatePicker
          label="Required date"
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">Disabled DatePicker</h3>
        <DatePicker
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">With Error Message</h3>
        <DatePicker
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">With Min Date (One week ago)</h3>
        <DatePicker
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">With Max Date (One week later)</h3>
        <DatePicker
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">With Specific Disabled Dates</h3>
        <DatePicker
