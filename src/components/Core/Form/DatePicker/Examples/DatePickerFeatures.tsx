...
export default component$(() => {
  ...
  return (
    <div class="space-y-8">
      <div>
        <h3 class="text-sm font-semibold mb-2">Inline DatePicker</h3>
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">Custom Date Format</h3>
        <DatePicker
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">Week Starts on Monday</h3>
        <DatePicker
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">Show Week Numbers</h3>
        <DatePicker
