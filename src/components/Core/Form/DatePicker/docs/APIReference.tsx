...
export default component$(() => {
  const commonProps: PropDetail[] = [
    ...
    },
    {
      ...
      type: "boolean",
      defaultValue: "true",
      description: "Whether to close the calendar popup when a date is selected"
    },
    {
    ...
    },
    {
      ...
      type: "boolean",
      defaultValue: "false",
      description: "Whether the datepicker should take up the full width of its container"
    },
    {
      name: "weekStart",
      type: "0 | 1 | 2 | 3 | 4 | 5 | 6",
  ...
  const rangeDatePickerProps: PropDetail[] = [
    ...
    },
    {
      ...
      type: "boolean",
      defaultValue: "true",
      description: "Whether to automatically apply the date range when selected"
    },
    {
  ...
  return (
    ...
    >
      <p>
        The DatePicker component provides a flexible interface for selecting dates and date ranges.
        It supports three main modes: single date selection, date range selection, and datetime selection.
      </p>
      <p class="mt-3">
        Each mode has its own set of specific props in addition to the common props shown above.
      </p>
      
      <h3 class="text-lg font-medium mt-8 mb-4">Single Date Mode Props</h3>
      ...
      <h3 class="text-lg font-medium mt-8 mb-4">Date Range Mode Props</h3>
      <table class="w-full border-collapse">
        <thead>
          <tr class="border-b border-border dark:border-border-dark">
            <th class="py-2 px-4 text-left">Name</th>
      ...
      <h3 class="text-lg font-medium mt-8 mb-4">DateTime Mode Props</h3>
      <table class="w-full border-collapse">
        <thead>
          <tr class="border-b border-border dark:border-border-dark">
            <th class="py-2 px-4 text-left">Name</th>
