...
export default component$(() => {
  const props: PropDetail[] = [
    ...
    },
    {
      name: "id",
      type: "string",
      description: "ID for the password input element. If not provided, a unique ID is generated"
    },
    {
      name: "class",
      type: "string",
    ...
    },
    {
      name: "toggleLabel",
      type: "string",
      description: "Accessibility label for the password visibility toggle button"
    },
    {
      name: "showStrength",
      type: "boolean",
  ...
  return (
    ...
    >
      <p>
        The PasswordField component is built on top of the standard HTML password input with additional
        features like visibility toggling and strength indicators. It supports all standard input behaviors
        along with specialized password-related functionality.
      </p>
      <p class="mt-3">
        The component handles both controlled and uncontrolled input patterns through the value and
        onValueChange$ props. For more complex event handling, you can use the onInput$ and onChange$ props.
      </p>
      <p class="mt-3">
        The PasswordStrengthIndicator subcomponent is automatically included when the showStrength prop
        is set to true. It calculates password strength based on length and character variety.
      </p>
    </APIReferenceTemplate>
  );
}); 