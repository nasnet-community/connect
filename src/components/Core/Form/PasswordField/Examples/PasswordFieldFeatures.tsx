...
export default component$(() => {
  ...
  return (
    <div class="max-w-md space-y-8">
      <div>
        <h3 class="text-sm font-semibold mb-2">Password with Visibility Toggle</h3>
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">Password with Strength Indicator</h3>
        <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">
      ...
      <div>
        <h3 class="text-sm font-semibold mb-2">Initially Visible Password</h3>
        <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">
