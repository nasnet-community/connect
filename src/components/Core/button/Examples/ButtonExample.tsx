...
import { HiArrowRightOutline, HiCheckOutline, HiExclamationTriangleOutline } from "@qwikest/icons/heroicons";
...
export const ButtonColorExample = component$(() => {
  return (
    <div class="flex flex-wrap gap-4">
      ...
      <Button class="bg-warning-600 hover:bg-warning-700 text-warning-foreground">Warning</Button>
...
export const ButtonWithEventExample = component$(() => {
  return (
    <div class="flex flex-wrap gap-4">
      ...
      >
        <span q:slot="leftIcon"><HiExclamationTriangleOutline class="h-4 w-4" /></span>
        With Alert
      </Button>
    </div>
  );
