 ...
 */
export const applyTrafficStyling = (connection: GraphConnection): GraphConnection => {
 ...
 */
export const processConnections = (connections: GraphConnection[]): GraphConnection[] => {
