 ...
 */
export const applyConnectionStyling = (connection: GraphConnection): GraphConnection => {
 ...
 */
export const processConnectionTypes = (connections: GraphConnection[]): GraphConnection[] => {
...
export const connectionIcons = {
  Ethernet: "M2 16.1A5 5 0 0 1 5.9 20M2 12.05A9 9 0 0 1 9.95 20M2 8V6a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-6",
  Wireless: "M8.111 16.404a5.5 5.5 0 0 1 7.778 0M12 12a9 9 0 0 1 6.364 2.636M12 8c2.648 0 5.195.89 7.272 2.545",
  LTE: "M3 8l7.89 5.26a2 2 0 0 0 2.22 0L21 8M5 19h14a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2z",
  Satellite: "M19 21a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h3a2 2 0 0 1 2 2z",
  DSL: "M12 19l7-7 3 3-7 7-3-3z M18 13l-1.5-7.5L2 2l3.5 14.5L13 18l5-5z",
  Fiber: "M9.663 17h4.673M12 3v1m0 16v1m-8-8h1m16 0h1M4.6 4.6l.7.7m12.4-.7l-.7.7m-.7 12.4l.7.7M5.3 16.7l.7-.7"
};
