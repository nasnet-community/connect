...
export const GraphOverview = component$(() => {
  ...
  return (
    ...
    >
      <p>
        The Graph component is a versatile visualization tool for rendering network topologies, 
        connection diagrams, and relationship graphs. It's designed to visualize nodes and their 
        connections with customizable styling, animations, and interactive behaviors.
      </p>
    </OverviewTemplate>
  );
});
