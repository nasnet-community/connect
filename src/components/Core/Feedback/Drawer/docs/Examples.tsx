...
import { BasicDrawer, PlacementDrawer, SizeDrawer, DrawerWithFooter } from "../Examples";
  ...
  return (
    <div class="space-y-10">
      <section class="space-y-4">
        ...
        <p>
          The most basic usage of the Drawer component includes a header, content area, and a close button.
          The drawer appears from the right side of the screen by default.
        </p>
  ...
  return (
    <div class="space-y-4">
      ...
      <section class="space-y-4">
        ...
        <p>
          Drawers can be positioned to appear from any of the four sides of the screen: left, right, top, or bottom.
          Use the <code>placement</code> prop to control the drawer's position.
        </p>
        <div class="border rounded-lg p-4 bg-white dark:bg-gray-800">
          <PlacementDrawer />
        </div>
    ...
    <div class="space-y-4">
      ...
      <section class="space-y-4">
        ...
        <p>
          ...
          Use the <code>size</code> prop to control the drawer's dimensions.
        </p>
        <div class="border rounded-lg p-4 bg-white dark:bg-gray-800">
          <SizeDrawer />
        </div>
