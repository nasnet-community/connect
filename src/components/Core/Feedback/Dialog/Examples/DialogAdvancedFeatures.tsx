...
import { 
  ...
  DialogBody, 
  DialogFooter 
} from '~/components/Core/Feedback/Dialog';
...
export const DialogAdvancedFeatures = component$(() => {
  ...
  return (
    <div class="space-y-6">
      <div>
        <h3 class="text-sm font-medium mb-2">Scrollable Dialog</h3>
        ...
        >
          ...
          <DialogBody scrollable={true}>
            <div class="space-y-4">
              <p>This dialog demonstrates scrollable content when the content exceeds the available height.</p>
              ...
              {Array.from({ length: 20 }).map((_, index) => (
                <div key={index} class="p-3 bg-gray-100 dark:bg-gray-700 rounded">
                  ...
                  <p>
                    This is a section of content that will make the dialog body scrollable.
                    When there is a lot of content, the dialog body will scroll while keeping
      ...
      <div>
        <h3 class="text-sm font-medium mb-2">Form Dialog</h3>
        ...
        >
            ...
            <form preventdefault:submit class="space-y-4">
              <div>
                ...
                <input
                  ...
                  onInput$={(e: any) => formState.value = {...formState.value, name: e.target.value}}
                  class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700"
                  required
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onInput$={(e: any) => formState.value = {...formState.value, email: e.target.value}}
                  class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700"
                  required
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  onInput$={(e: any) => formState.value = {...formState.value, message: e.target.value}}
                  class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700"
                  required
                ></textarea>
              </div>
          ...
          <DialogFooter>
            <div class="flex justify-end gap-3">
              ...
              <Button 
                onClick$={submitForm}
                disabled={!formState.value.name || !formState.value.email || !formState.value.message}
              >
                Submit
              </Button>
            </div>
