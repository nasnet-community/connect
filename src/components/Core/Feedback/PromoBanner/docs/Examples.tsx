  ...
  return (
    <div class="space-y-10">
      <section class="space-y-4">
        ...
        <p>
          The basic PromoBanner displays promotional content with a title, description, and provider
          name. This is the simplest usage of the component.
        </p>
  ...
  return (
    ...
    />
      ...
      <section class="space-y-4">
        ...
        <p>
          Adding an image to the PromoBanner makes it more visually appealing and helps users
          recognize the VPN service provider.
        </p>
        <div class="border rounded-lg p-4 bg-white dark:bg-gray-800">
          <ImagePromoBanner />
        </div>
  ...
  return (
    ...
    />
      ...
      <section class="space-y-4">
        ...
        <p>
          The PromoBanner component can be customized with different background colors and additional
          CSS classes to match your application's design.
        </p>
        <div class="border rounded-lg p-4 bg-white dark:bg-gray-800">
          <CustomStylePromoBanner />
        </div>
  ...
  return (
    ...
    />
      ...
      <section class="space-y-4">
        ...
        <p>
          The PromoBanner can include interactive elements like a button to retrieve VPN
          credentials. This example demonstrates how to handle the credential callback.
        </p>
        <div class="border rounded-lg p-4 bg-white dark:bg-gray-800">
          <InteractivePromoBanner />
        </div>
