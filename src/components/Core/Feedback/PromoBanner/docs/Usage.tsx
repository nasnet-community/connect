  ...
  return (
    <div class="space-y-6">
      <section class="space-y-4">
        ...
        <p>
          The PromoBanner component is used to display promotional content related to VPN services.
  ...
  return (
    ...
    />
      ...
      <section class="space-y-4">
        ...
        <p>
          You can make the PromoBanner more visually appealing by adding an image:
        </p>
        <CodeBlock
          code={`
import { component$ } from '@builder.io/qwik';
  ...
  return (
    ...
    />
      ...
      <section class="space-y-4">
        ...
        <p>
          Customize the PromoBanner appearance with background colors and additional CSS classes:
        </p>
        <CodeBlock
          code={`
import { component$ } from '@builder.io/qwik';
  ...
  return (
    ...
    />
      ...
      <section class="space-y-4">
        ...
        <p>
          Enable users to retrieve VPN credentials by adding a callback function:
        </p>
        <CodeBlock
          code={`
    ...
    <div>
      ...
      <section class="space-y-4">
        ...
        <CodeBlock
          code={`
import { component$, $ } from '@builder.io/qwik';
import { usePromoBanner } from '~/components/Core/Feedback/PromoBanner/usePromoBanner';
import type { VPNCredentials } from '~/components/Core/Feedback/PromoBanner';
    ...
    <div class="p-6 bg-gray-100 dark:bg-gray-800 rounded-lg">
      ...
      <section class="space-y-4">
        ...
        <ul class="list-disc pl-6 space-y-2">
          <li>
            <strong>Clear Messaging:</strong> Use concise and clear language for the promotion title and description.
          </li>
          <li>
            <strong>Visual Appeal:</strong> Include relevant images when possible to make the promotion more engaging.
          </li>
          <li>
            <strong>Strategic Placement:</strong> Place PromoBanners in locations where they won't disrupt the main user flow but are still visible.
          </li>
          <li>
            <strong>Temporary Display:</strong> Consider using state management to display PromoBanners only for a limited time or until dismissed.
          </li>
          <li>
            <strong>Response Handling:</strong> Always handle loading, success, and error states for credential retrieval.
          </li>
          <li>
            <strong>Dark Mode Support:</strong> Ensure your custom styling works well in both light and dark modes.
          </li>
        </ul>
      </section>
      ...
      <section class="space-y-4">
        ...
        <ul class="list-disc pl-6 space-y-2">
          <li>
            Ensure promotional images have appropriate alt text for screen readers.
          </li>
          <li>
            Use sufficient color contrast for text content to maintain readability.
          </li>
          <li>
            Add ARIA attributes to interactive elements when necessary for better screen reader support.
          </li>
          <li>
            Ensure buttons have descriptive text that explains their purpose.
          </li>
          <li>
            Provide visual feedback (such as loading states and success messages) for user interactions.
          </li>
        </ul>
      </section>
    </div>
