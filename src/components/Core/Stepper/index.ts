...
export {
  ...
  useStepperContext,
} from "./CStepper/hooks/useStepperContext";
export type {
  CStepMeta,
  CStepperProps,
  CStepperContext,
...
export type {
  HStepperProps,
  StepperMode as HStepperMode,
  StepItem as HStepItem,
} from "./HStepper/HSteppertypes";

// VStepper exports
export { VStepper } from "./VStepper";
export type {
  VStepperProps,
  StepItem as VStepItem,
  StepComponentProps as VStepComponentProps,
} from "./VStepper/types";
