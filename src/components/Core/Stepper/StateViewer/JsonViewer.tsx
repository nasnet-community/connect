...
export const JsonViewer = component$<JsonViewerProps>((props) => {
      ...
      <>
          ...
          {rootKeys.map((key) => {
            ...
            return (
              <button
                ...
                class={`flex items-center gap-2 whitespace-nowrap border-b-2 px-4 py-2.5 text-sm font-medium transition-colors ${
                  isActive
        ...
        <div class="p-4 font-mono text-sm">
          {activeTab.value && data[activeTab.value] !== undefined ? (
            typeof data[activeTab.value] === "object" &&
            data[activeTab.value] !== null ? (
              Object.entries(data[activeTab.value]).map(
  ...
  const renderRawView = () => {
    return (
      <pre class="overflow-auto p-4 font-mono text-sm">
  ...
  return (
    <div
      class={`bg-surface-secondary/50 dark:bg-surface-dark-secondary/50 rounded-lg ${className}`}
    >
      {/* Header Controls */}
      <div class="flex flex-col items-start justify-between gap-3 border-b border-gray-200 p-3 dark:border-gray-700 sm:flex-row sm:items-center">
        <div class="flex w-full items-center gap-2 sm:w-auto">
          ...
          {(viewMode.value === "tree" || viewMode.value === "tabs") && (
            <div class="relative flex-1 sm:flex-initial">
              <input
                ...
                class="w-full rounded-md border border-gray-300 bg-white px-3 py-1.5 pl-8 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-800 sm:w-48"
              />
              <svg
          ...
          {/* View Mode Selector */}
          <div class="flex items-center gap-1 rounded-md bg-gray-100 p-0.5 dark:bg-gray-800">
            <button
