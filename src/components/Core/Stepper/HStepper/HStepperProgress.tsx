                    ...
                    shadow-lg transition-all duration-300 ${
                      step.isComplete
                        ...
                        : index === props.activeStep
                          ...
                          : "bg-surface-secondary/60 dark:bg-surface-dark-secondary/80 border-border/40 dark:border-border-dark"
                    }`}
                  >
                    {step.isComplete ? (
                  ...
                  <span
                    class={`mt-2 text-sm transition-all duration-300 ${
                      index === props.activeStep
                        ...
                        : "text-text-secondary dark:text-text-dark-secondary/80 font-medium"
                    }`}
                  >
                    {step.title}
                  </span>
 ...
 */
export const HelpSettingsToggle = component$<HelpSettingsToggleProps>(
  (props) => {
    const {
    ...
    return (
      <div class={`inline-flex items-center gap-2 ${className}`}>
        ...
        <span id="help-toggle-description" class="sr-only">
          When enabled, help modals will automatically appear when navigating to
          steps that have help content available across all stepper components
        </span>
      </div>
    );
  },
