...
export const StepperManagement = component$<StepperManagementProps>((props) => {
  ...
  const getStepperTitle = () => {
    switch (stepperType) {
      case "vertical":
        return "Manage Vertical Steps";
      case "horizontal":
        return "Manage Horizontal Steps";
      default:
        return "Manage Steps";
    }
  };
  ...
  const getStepperClass = () => {
    switch (stepperType) {
      case "vertical":
        return "stepper-management-vertical";
      case "horizontal":
        return "stepper-management-horizontal";
      default:
        return "stepper-management-content";
    }
  };

  return (
    <div
      class={`mb-8 rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800 ${getStepperClass()}`}
    >
            ...
            <div class="flex items-center gap-1">
              ...
              {steps.length > 1 && (
                <button
                  ...
                  class="p-1.5 text-red-500 transition-colors hover:text-red-700 dark:text-red-400 dark:hover:text-red-300"
                  title="Remove step"
      ...
      {isAddingStep.value ? (
          ...
          <div class="space-y-3">
            <div>
              ...
              <input
                ...
                onInput$={(e) =>
                  (newStepTitle.value = (e.target as HTMLInputElement).value)
                }
                class="w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
            ...
            <div>
              ...
              <select
                ...
                onChange$={(e) =>
                  (insertPosition.value = (e.target as HTMLSelectElement).value)
                }
                class="w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
              >
            ...
            <div class="flex gap-2">
              <button
                ...
                onClick$={() => {
                  if (newStepTitle.value.trim()) {
                    ...
                    const position = insertPosition.value
                      ? parseInt(insertPosition.value) + 1
                      : undefined;
                ...
                class="rounded-md bg-primary-600 px-4 py-2 text-white transition-colors hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500 dark:bg-primary-500 dark:hover:bg-primary-600"
              >
                Add Step
              </button>
              <button
                ...
                class="rounded-md bg-gray-200 px-4 py-2 text-gray-700 transition-colors hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-500 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600"
              >
                Cancel
              </button>
            </div>
        ...
        <button
          ...
          class="w-full rounded-md bg-primary-600 px-4 py-2 text-white transition-colors hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500 dark:bg-primary-500 dark:hover:bg-primary-600"
        >
          Add New Step
        </button>
      )}
