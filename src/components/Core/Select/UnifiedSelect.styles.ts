...
export const styles = {
  ...
  helperText:
    "mt-2 text-sm mobile:text-base tablet:text-sm text-gray-600 dark:text-gray-400 transition-colors duration-200",

  errorMessage:
    "mt-2 text-sm mobile:text-base tablet:text-sm text-error-600 dark:text-error-400 transition-colors duration-200",
  ...
  nativeSizeSm:
    "text-xs px-2.5 py-1.5 mobile:min-h-[44px] mobile:px-3 mobile:py-2.5 mobile:text-base tablet:text-xs tablet:px-2.5 tablet:py-1.5 desktop:text-xs",
  nativeSizeMd:
    "text-sm px-3 py-2 mobile:min-h-[48px] mobile:px-4 mobile:py-3 mobile:text-base tablet:px-3 tablet:py-2 desktop:text-sm",
  nativeSizeLg:
    "text-base px-4 py-2.5 mobile:min-h-[52px] mobile:px-5 mobile:py-3.5 mobile:text-lg tablet:px-4 tablet:py-2.5 desktop:text-base",
  ...
  buttonSizeSm:
    "text-xs px-2.5 py-1.5 mobile:min-h-[44px] mobile:px-3 mobile:py-2.5 mobile:text-base tablet:text-xs tablet:px-2.5 tablet:py-1.5 desktop:text-xs desktop:px-2.5 desktop:py-1.5",
  buttonSizeMd:
    "text-sm px-3 py-2 mobile:min-h-[48px] mobile:px-4 mobile:py-3 mobile:text-base tablet:px-3 tablet:py-2 tablet:text-sm desktop:text-sm desktop:px-3 desktop:py-2",
  buttonSizeLg:
    "text-base px-4 py-2.5 mobile:min-h-[52px] mobile:px-5 mobile:py-3.5 mobile:text-lg tablet:px-4 tablet:py-2.5 tablet:text-base desktop:text-base desktop:px-4 desktop:py-2.5",
  ...
  optionsContainer:
    "overflow-auto max-h-[300px] mobile:max-h-[calc(85vh-120px)] tablet:max-h-[400px] desktop:max-h-[500px] overscroll-contain scrollbar-thin scrollbar-track-gray-100 dark:scrollbar-track-gray-700 scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600 hover:scrollbar-thumb-gray-400 dark:hover:scrollbar-thumb-gray-500",
  ...
  checkboxSelected:
    "text-primary-500 dark:text-primary-400 border-primary-500 dark:border-primary-400 bg-primary-50 dark:bg-primary-900/20",

  noResults:
    "px-3 py-4 mobile:px-4 mobile:py-6 text-sm mobile:text-base text-gray-500 dark:text-gray-400 text-center italic",

  // Enhanced mobile-specific styles with better UX
  mobileBackdrop:
    "mobile:fixed mobile:inset-0 mobile:bg-black/50 mobile:z-[1040] tablet:hidden backdrop-blur-sm",
  mobileHandle:
    "mobile:block mobile:w-12 mobile:h-1.5 mobile:bg-gray-300 dark:mobile:bg-gray-600 mobile:rounded-full mobile:mx-auto mobile:mb-4 mobile:mt-2 tablet:hidden",
  mobileHeader:
    "mobile:flex mobile:items-center mobile:justify-between mobile:p-4 mobile:pb-2 mobile:border-b mobile:border-gray-200 dark:mobile:border-gray-600 tablet:hidden",
  mobileCloseButton:
    "mobile:p-2 mobile:rounded-lg mobile:hover:bg-gray-100 dark:mobile:hover:bg-gray-700 mobile:transition-colors mobile:duration-200 mobile:min-h-[44px] mobile:min-w-[44px] mobile:flex mobile:items-center mobile:justify-center",

  // Loading state styles
  loadingOverlay:
    "absolute inset-0 bg-white/80 dark:bg-gray-800/80 flex items-center justify-center backdrop-blur-sm z-20",
  loadingContainer:
    "flex items-center space-x-2 text-gray-600 dark:text-gray-400",

  // Focus management styles
  focusRing:
    "focus-visible:ring-2 focus-visible:ring-primary-500/20 dark:focus-visible:ring-primary-400/20 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-gray-800",

  // High contrast mode support
  highContrast:
    "high-contrast:border-2 high-contrast:border-black high-contrast:bg-white high-contrast:text-black",
};
