 ...
 */
export type ResponsiveGridItemValue<T> =
  | T
  | {
      base?: T;
      sm?: T;
...
export interface GridItemProps {
  ...
  justifySelf?: ResponsiveGridItemValue<
    "auto" | "start" | "center" | "end" | "stretch"
  >;

  alignSelf?: ResponsiveGridItemValue<
