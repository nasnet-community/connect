...
`;
  ...
  return (
    ...
    >
      <p>
        Box is a foundational layout component that provides a consistent way to apply spacing,
        backgrounds, borders, and other styling. It forms the building block for more complex
        layouts and UI elements in your application.
      </p>
      
      <p class="mt-4">
        The Box component is highly versatile and can be used for a wide range of UI needs, from
        simple containers to more complex card-like interfaces. It uses theme-aware props to ensure
