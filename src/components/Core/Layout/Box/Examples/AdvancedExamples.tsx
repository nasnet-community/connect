...
export default component$(() => {
  return (
    <div class="space-y-6">
      ...
      <h2 class="text-xl font-semibold mt-8">Layout Examples</h2>
      ...
      <h2 class="text-xl font-semibold mt-8">Accessibility Examples</h2>
      <div class="space-y-4">
        <Box 
          padding="md" 
          backgroundColor="surface" 
        ...
        >
          ...
          <p id="box-description" class="sr-only">This description is read by screen readers</p>
        </Box>
      </div>
    </div>
  );
