...
export function useDivider(props: DividerProps) {
  ...
  const labelPositionClasses = {
    ...
    'before:content-[""] before:flex-grow': !!label && orientation === 'horizontal',
    'after:content-[""] after:flex-grow': !!label && orientation === 'horizontal',
    'before:mr-4': label && orientation === 'horizontal' && (labelPosition === 'center' || labelPosition === 'end'),
    'after:ml-4': label && orientation === 'horizontal' && (labelPosition === 'center' || labelPosition === 'start'),
    'before:mr-0': label && orientation === 'horizontal' && labelPosition === 'start',
    'after:ml-0': label && orientation === 'horizontal' && labelPosition === 'end',
  };
