  ...
  return (
    <div>
      <>
        ...
        <Box padding="sm" backgroundColor="secondary" borderRadius="md" class="text-white">
          Second box (no space between on mobile)
        </Box>
        <p class="text-sm mt-4 text-gray-600 dark:text-gray-300">
          On mobile screens, the boxes will be stacked without the spacer.
          On larger screens (sm breakpoint and above), there will be xl space between the boxes.
        </p>
      </>
    </div>
  );
