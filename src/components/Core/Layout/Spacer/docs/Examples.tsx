...
import { ExamplesTemplate, type Example } from '~/components/Docs/templates/ExamplesTemplate';
...
export const SpacerExamples = component$(() => {
  const examples: Example[] = [
    ...
    {
      title: "Size Variants",
      description: "Spacers come in multiple sizes: xs, sm, md, lg, xl, 2xl, 3xl, and 4xl.",
      component: <SpacerSizes />
    },
    {
      title: "Horizontal Spacer",
      description: "Use the horizontal prop to create horizontal spacing between elements in a flex container.",
      component: <SpacerHorizontal />
    },
    {
      title: "Flexible Spacer",
      description: "Use isFlexible prop to create a spacer that grows to fill available space, pushing content apart.",
    ...
    },
    {
      ...
      description: "Hide a spacer on mobile screens to create more compact layouts on small devices.",
  ...
  return (
    <ExamplesTemplate examples={examples}>
      <p class="mb-4">
        The following examples demonstrate various ways to use the Spacer component to create
        consistent spacing in your layouts.
      </p>
    </ExamplesTemplate>
  );
});
