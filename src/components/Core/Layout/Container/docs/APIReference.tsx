...
export default component$(() => {
  const props: PropDetail[] = [
    ...
    },
    {
      name: "fixedWidth",
      type: "boolean",
      description: "When true, applies max-width at all breakpoints instead of being responsive",
      defaultValue: "false"
    },
    {
      name: "class",
  ...
  return (
    ...
    >
      <p>
        The Container component is a layout primitive that provides consistent width constraints
        and padding options. It's designed to work with Qwik's component model and integrates
        with the application's responsive design system.
      </p>
      
      <h3 class="text-lg font-medium mt-6 mb-2">Size Values</h3>
      <p class="mb-4">
        The Container component supports the following size values for the maxWidth prop:
      </p>
      <table class="min-w-full border-separate border-spacing-0 mb-4">
        ...
        <tbody>
          <tr>
            ...
            <td class="border-b px-4 py-2">Narrow focused content like single-column forms</td>
          </tr>
          <tr>
            <td class="border-b px-4 py-2">'sm'</td>
            <td class="border-b px-4 py-2">384px</td>
            <td class="border-b px-4 py-2">Small dialog content or reading areas</td>
          </tr>
          <tr>
            <td class="border-b px-4 py-2">'md'</td>
            <td class="border-b px-4 py-2">448px</td>
            <td class="border-b px-4 py-2">Medium-sized forms or content sections</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="border-b px-4 py-2">Wider content areas like dashboards</td>
          </tr>
          <tr>
            <td class="border-b px-4 py-2">'2xl'</td>
            <td class="border-b px-4 py-2">672px</td>
            <td class="border-b px-4 py-2">Large, expansive content while maintaining readability</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="border-b px-4 py-2">No max-width, only controlled by padding</td>
          </tr>
        </tbody>
      </table>
      
      <h3 class="text-lg font-medium mt-6 mb-2">Padding Values</h3>
      <p class="mb-4">
      ...
      <p>
        While the Container component is primarily a visual layout element, there are cases
        where it might represent a landmark or section in your application. In these cases,
        use the <code>role</code> and <code>aria-label</code> props to provide proper
        accessibility information:
      </p>
      <ul class="list-disc pl-5 space-y-1 mt-2">
        <li>Use <code>role="region"</code> when the container represents a significant section</li>
        <li>Provide an <code>aria-label</code> to describe the container's purpose when using a role</li>
        <li>Ensure sufficient color contrast for content within the container</li>
      </ul>
    </APIReferenceTemplate>
  );
});
