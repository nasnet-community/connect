...
export default component$(() => {
  ...
  const ContainerDemo = component$<{
    ...
    return (
      <div class="min-h-[400px] w-full bg-gray-100 dark:bg-gray-800 p-4 flex items-center justify-center">
        <Container
          maxWidth={maxWidth}
          paddingX={paddingX}
          paddingY={paddingY}
        ...
        >
          <div class="min-h-[100px] w-full flex flex-col items-center justify-center">
            <div class="text-center">
              <p class="text-md font-medium">Container</p>
              <p class="text-sm text-gray-500 dark:text-gray-400">maxWidth: {maxWidth}</p>
              <p class="text-xs text-gray-500 dark:text-gray-400">
                paddingX: {paddingX} | paddingY: {paddingY}
              </p>
              <p class="text-xs text-gray-500 dark:text-gray-400">
                {centered ? 'Centered' : 'Not Centered'} | {fixedWidth ? 'Fixed Width' : 'Responsive'}
              </p>
            </div>
          </div>
        </Container>
