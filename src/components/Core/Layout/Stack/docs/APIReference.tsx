...
export const StackAPIReference = component$(() => {
  const props: PropDetail[] = [
    {
      ...
      defaultValue: "'column'",
      description: 'The direction to arrange items. Can be a fixed direction or responsive object for different breakpoints.',
    },
    {
      name: 'spacing',
  ...
  const cssVariables: { name: string; description: string; defaultValue?: string }[] = [];
  ...
  return (
    <>
      ...
      <div class="mt-8">
        <h3 class="text-lg font-medium mb-4">Type Definitions</h3>
        <CodeExample
