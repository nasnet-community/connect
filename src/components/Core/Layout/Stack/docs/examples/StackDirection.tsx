...
export const StackDirection = component$(() => {
  return (
    <>
      <div class="space-y-6">
        <div>
          <p class="text-sm text-gray-500 dark:text-gray-400 mb-2">Vertical Stack (column direction)</p>
        ...
        <div>
          <p class="text-sm text-gray-500 dark:text-gray-400 mb-2">Horizontal Stack (row direction)</p>
