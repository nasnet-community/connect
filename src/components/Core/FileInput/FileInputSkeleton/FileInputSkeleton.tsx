...
export const FileInputSkeleton = component$<FileInputSkeletonProps>(
  ({ variant = "simple", animate = true, lines = 4 }) => {
    ...
    return (
      <div
        class={`bg-surface-light rounded-lg border border-gray-200 p-4 dark:border-gray-700 dark:bg-surface-dark sm:p-6 ${animationClass}`}
      >
        {/* Header skeleton */}
        <div class="mb-4">
        ...
        <div class="flex flex-col gap-4 tablet:flex-row tablet:gap-6">
          ...
          <div class="flex gap-2 mobile:w-full tablet:w-auto tablet:flex-col tablet:gap-3">
            <div class="h-10 flex-1 rounded-lg bg-gray-300 dark:bg-gray-600 tablet:w-32 tablet:flex-initial" />
            <div class="h-10 flex-1 rounded-lg bg-gray-300 dark:bg-gray-600 tablet:w-32 tablet:flex-initial" />
          </div>
        </div>
      </div>
