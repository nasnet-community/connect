...
export const PaginationButton = component$<PaginationButtonProps>(({
  ...
  const baseButtonClasses = 'inline-flex items-center justify-center rounded focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-1';
  ...
  const variantClasses = {
    default: {
      ...
      currentPage: 'bg-primary-500 text-white hover:bg-primary-600 dark:bg-primary-600 dark:hover:bg-primary-500',
    },
    outlined: {
      ...
      currentPage: 'border-primary-500 bg-white text-primary-600 dark:border-primary-500 dark:bg-gray-800 dark:text-primary-400',
    },
    minimal: {
      button: `${baseButtonClasses} text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700`,
      currentPage: 'bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-200',
    }
  };
