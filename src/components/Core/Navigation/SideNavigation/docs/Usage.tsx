  ...
  const guidelines = [
    {
      ...
      description: 'Make your side navigation responsive by toggling between fixed and off-canvas modes based on screen size.',
      code: `
import { component$, useSignal, useVisibleTask$ } from '@builder.io/qwik';
import { SideNavigation, SideNavigationItem, SideNavigationBackdrop } from '~/components/Core/Navigation/SideNavigation';
...
export default component$(() => {
  ...
  return (
    ...
    },
    {
      ...
      description: 'Group related navigation items under expandable sections for better organization.',
      code: `
<SideNavigation>
  ...
  <SideNavigationItem label="Settings" expandable={true}>
    ...
    },
    {
      ...
      description: 'If using icons, apply them consistently across all navigation items for visual balance.',
      code: `
<SideNavigation>
  ...
  />
    ...
    },
    {
      ...
      description: 'Avoid creating deep hierarchies that make navigation confusing and difficult to use.',
      code: `
<SideNavigation>
  <SideNavigationItem label="Products" expandable={true}>
    ...
    },
    {
      ...
      description: "Don't mix different navigation patterns in the same side navigation.",
      code: `
<SideNavigation>
  ...
  />
    ...
    },
    {
      ...
      description: 'Make sure your side navigation is usable on mobile devices with proper open/close controls.',
      code: `
...
<SideNavigation>
  ...
  const bestPractices = [
    {
      ...
      description: 'Always indicate the current page or section to help users understand their location in the navigation hierarchy.'
    },
    {
      title: 'Limit navigation depth',
      description: 'Try to limit navigation to no more than 2-3 levels deep to prevent confusion and excessive clicking.'
    },
    {
      title: 'Use clear labels',
      description: 'Use concise but descriptive labels for navigation items to clearly communicate their destination.'
    },
    {
      title: 'Group related items',
      description: 'Organize related navigation items under expandable sections to reduce cognitive load and improve findability.'
    }
  ];
  ...
  const accessibilityTips = [
    {
      ...
      description: 'The SideNavigation uses proper semantic nav element and appropriate ARIA roles.'
    },
    {
      title: 'Support keyboard navigation',
      description: 'Ensure users can navigate through all menu items using the keyboard, including expanding/collapsing sections.'
    },
    {
      title: 'Provide ARIA labels',
      description: 'Set descriptive ariaLabel prop to provide context for screen reader users.'
    },
    {
      title: 'Indicate current page',
      description: 'Use the isActive prop to apply aria-current="page" for the current page, helping screen reader users understand their location.'
    }
  ];
  ...
  return (
    ...
    >
      <p>
        The SideNavigation component provides a flexible system for implementing vertical navigation
        in your application. This section offers guidelines and best practices for using the component
        effectively, focusing on organization, responsiveness, and accessibility.
      </p>
    </UsageTemplate>
  );
});
