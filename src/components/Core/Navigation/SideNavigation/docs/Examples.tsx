...
export default component$(() => {
  const examples = [
    ...
    },
    {
      ...
      description: 'Hierarchical navigation with expandable sections and nested items.',
      component: <NestedItems />
    },
    {
      title: 'Responsive Navigation',
      description: 'Mobile-friendly side navigation that transforms into an off-canvas menu.',
  ...
  return (
    <ExamplesTemplate examples={examples}>
      <p>
        The following examples demonstrate various configurations and use cases for the SideNavigation
        component. From simple flat navigation to complex hierarchical structures, these examples
        showcase the flexibility and features of the component.
      </p>
    </ExamplesTemplate>
  );
});
