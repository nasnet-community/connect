...
export const SideNavigation = component$<SideNavigationProps>((props) => {
  ...
  const { isCollapsed, handleToggleCollapse$, handleCloseMobile$ } = useSideNavigationState({
    isCollapsed: propIsCollapsed,
    onToggleCollapse$: props.onToggleCollapse$ ? $(props.onToggleCollapse$) : undefined,
    isMobileOpen,
    onCloseMobile$: props.onCloseMobile$ ? $(props.onCloseMobile$) : undefined
  });
  ...
  const { containerClass, backdropClass, headerClass, toggleButtonClass } = useSideNavigationClasses({
