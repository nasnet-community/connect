  ...
  (props) => {
    ...
    return (
      <>
        ...
        <div
          class={`
            fixed left-0 right-0 top-full z-50 max-h-[calc(100vh-4rem)]
            overflow-y-auto md:hidden
            ${
              isMobileMenuOpen
                ? "opacity-100 motion-safe:animate-slide-down motion-safe:duration-300"
                : "opacity-0 motion-safe:animate-slide-up motion-safe:duration-200 motion-reduce:hidden"
            }
          `}
          id="mobile-menu"
        >
          <div
            class="
            mobile-nav-shadow space-y-2 border-t border-gray-200 bg-white/95
                ...
                <div key={`mobile-${itemLabel}-${index}`}>
                  ...
                  {!hasItems &&
                    (itemHref && !isDisabled ? (
                      <a
                        href={itemHref}
                        class={`
                        block flex min-h-[52px] touch-manipulation items-center rounded-lg px-4
                        py-3 text-base font-medium
                        focus-visible:outline-none focus-visible:ring-2
                        focus-visible:ring-primary-500 focus-visible:ring-offset-1 focus-visible:ring-offset-white
                        active:scale-95 motion-safe:transition-all
                        motion-safe:duration-200
                        motion-safe:active:transition-transform motion-safe:active:duration-100 dark:focus-visible:ring-offset-gray-900
                        ${
                          isActive
                      ...
                      <button
                        type="button"
                        class={`
                        block flex min-h-[52px] w-full touch-manipulation items-center rounded-lg px-4 py-3
                  ...
                  {hasItems && item.items && (
                    <div class="mt-4">
                      ...
                      <div class="border-b border-gray-200 px-4 py-2 text-xs font-semibold uppercase tracking-wider text-gray-500 dark:border-gray-700 dark:text-gray-400">
                        {itemLabel}
                      </div>
                            ...
                            <div key={`mobile-sub-${subItemLabel}-${subIndex}`}>
                              {subItemHref && !subItemIsDisabled ? (
                                <a
                                  href={subItemHref}
                                  class={`
                                  ml-4 block flex min-h-[52px] touch-manipulation items-center
                                ...
                                <button
                                  type="button"
                                  class={`
                                  ml-4 block flex min-h-[52px] w-full touch-manipulation items-center rounded-lg
          ...
          {rightContent && (
            <div
              class="
                mt-4 border-t border-gray-200 bg-gray-50/50 px-4
                py-4 pb-safe backdrop-blur-sm
                motion-safe:transition-colors motion-safe:duration-200
                dark:border-gray-700 dark:bg-gray-800/50
              "
            >
              <div class="space-y-3">{rightContent}</div>
            </div>
          )}
        </div>
      </>
