...
import { TopNavigationItem } from './TopNavigation.types';
...
export const TopNavigationHeader = component$<TopNavigationHeaderProps>((props) => {
  const { 
    logo, 
    items, 
    rightContent, 
        ...
        <div class="flex md:hidden">
          <button
            ...
            class="
              ...
              dark:hover:text-gray-100 dark:hover:bg-gray-800
