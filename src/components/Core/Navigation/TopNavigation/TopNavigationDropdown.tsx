...
export const TopNavigationDropdown = component$<TopNavigationDropdownProps>((props) => {
  ...
  return (
    <div class="
      absolute z-10 mt-1 left-0 w-48 origin-top-left
    ...
    ">
      <div class="py-1" role="menu" aria-orientation="vertical">
        {items.map((item, index) => {
          ...
          const disabledStateClass = isDisabled ? 'opacity-50 cursor-not-allowed' : '';
