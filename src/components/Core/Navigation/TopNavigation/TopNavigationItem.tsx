...
import type { TopNavigationItem, TopNavigationProps } from './TopNavigation.types';
...
export const TopNavigationItemComponent = component$<TopNavigationItemComponentProps>((props) => {
  ...
  const { isDropdownOpen, handleDropdownEnter$, handleDropdownLeave$ } = useDropdownState({
    hasItems,
    isDisabled
  });
