      ...
      <div class="flex justify-center">
        ...
        >
          <button
            ...
            class={`relative flex items-center px-4 py-2 text-sm font-medium rounded-md transition-all
              ${method === "file"
                ? "bg-primary-500 text-white shadow-sm"
                : "bg-transparent text-text-secondary hover:bg-gray-50 dark:text-text-dark-secondary dark:hover:bg-surface-dark-hover"
              }
