...
export const RadioInput = component$<RadioInputProps>(
  ({
    ...
    const baseClasses = [
      "w-4 h-4 border focus:ring-2 focus:outline-none",
    ...
    const validationClasses = {
      default: [
        ...
        "dark:border-gray-600 dark:bg-surface-dark-DEFAULT",
      ...
      valid: [
        ...
        "dark:border-success-400 dark:bg-surface-dark-DEFAULT",
      ...
      invalid: [
        ...
        "dark:border-error-400 dark:bg-surface-dark-DEFAULT",
      ...
      warning: [
        ...
        "dark:border-warning-400 dark:bg-surface-dark-DEFAULT",
      ...
      <div class={`w-full ${animate ? "motion-safe:animate-fade-in" : ""}`}>
        {label && (
          <fieldset>
            <legend
              class={[
                "mb-3 block font-medium text-gray-900 dark:text-white",
                size === "sm" ? "text-xs" : size === "md" ? "text-sm" : size === "lg" ? "text-base" : "text-lg",
                "rtl:text-end ltr:text-start",
              ].join(" ")}
            >
