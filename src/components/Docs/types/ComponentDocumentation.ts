...
export interface ComponentMetadata {
  name: string;
  path: string;
  category: 'layout' | 'input' | 'form' | 'dataDisplay' | 'navigation' | 'feedback' | 'typography' | 'other';
  description: string;
}
...
export const COMPONENT_CATEGORIES: ComponentCategory[] = [
  {
    id: 'layout',
    name: 'Layout',
    description: 'Components for creating layouts and organizing content on the page.',
    components: []
  },
  {
    id: 'input',
    name: 'Input',
    description: 'Components for collecting user input through various interactive elements.',
    components: []
  },
  {
    id: 'form',
  ...
  },
  {
    id: 'dataDisplay',
    name: 'Data Display',
    description: 'Components for displaying data in various formats and structures.',
    components: []
  },
  {
    id: 'navigation',
