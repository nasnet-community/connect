...
export const APITable = component$<APITableProps>(({ 
  ...
  return (
    <div class="overflow-x-auto mb-8">
      {title && (
        <h3 class="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white mb-4">{title}</h3>
      )}
        ...
        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
          {data.map((item, index) => (
            <tr key={index} class="bg-white dark:bg-gray-900">
              ...
              <td class="px-4 py-3 font-mono text-primary-600 dark:text-primary-400 whitespace-nowrap">
                {item.name}
              ...
              {type === 'props' && (
                <>
                  <td class="px-4 py-3 font-mono text-gray-500 dark:text-gray-400">{(item as PropDetail).type}</td>
                  ...
                  <td class="px-4 py-3 text-gray-600 dark:text-gray-300">{(item as PropDetail).description}</td>
                </>
              )}
              ...
              {type === 'events' && (
                <>
                  ...
                  <td class="px-4 py-3 text-gray-600 dark:text-gray-300">{(item as EventDetail).description}</td>
                </>
              )}
              ...
              {type === 'methods' && (
                <>
                  ...
                  <td class="px-4 py-3 text-gray-600 dark:text-gray-300">{(item as MethodDetail).description}</td>
                </>
              )}
